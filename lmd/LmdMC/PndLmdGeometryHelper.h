...
TGeoManager* fGeoManager;
  ...
  PndLmdGeometryHelper(
    ...
    for (boost::property_tree::ptree::value_type& nav_path :
         pt_general.get_child("navigation_paths")) {
      if (counter > 0)
  ...
  PndLmdHitLocationInfo translateVolumePathToHitLocationInfo(
 ...
 public:
  ...
  const PndLmdHitLocationInfo& getHitLocationInfo(
      const std::string& volume_path);
