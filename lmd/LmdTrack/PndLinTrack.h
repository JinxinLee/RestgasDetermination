...
class PndLinTrack : public TObject
{
 ...
 public:
  ...
  PndLinTrack(TString detName, Double_t p0, Double_t p1, Double_t p2, Double_t p3, Double_t p4,Double_t p5, 
	      Double_t chi, Int_t first, Int_t last, Int_t cand);
  ...
  /*   const { errpar[0]=fP0err;errpar[1]=fP1err;errpar[2]=fP2err;errpar[3]=fP3err;errpar[4]=fP4err;} */
