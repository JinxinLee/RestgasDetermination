...
// -----   Default constructor   -------------------------------------------
PndLmdTrackFinderTask::PndLmdTrackFinderTask(Int_t inFinderMode, TString hitBranch, TString clusterBranch, TString digiBranch, Int_t innSensPP) :
...
bool PndLmdTrackFinderTask::SortHitsByDet(std::vector< std::vector< std::pair<Int_t,bool> > > &hitsd, Int_t nStripHits)
{
  Int_t nPlanes=0;
...
bool PndLmdTrackFinderTask::SortHitsByZ(std::vector< std::vector< std::pair<Int_t,bool> > > &hitsd, Int_t nStripHits)
{
