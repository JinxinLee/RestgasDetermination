...
const shared_ptr<ModelPar> ModelParSet::addModelParameter(std::string name_,
	...
	if (modelParameterExists(name_)) {
		...
		model_par_map[std::make_pair(model_name, name_)] = shared_ptr<ModelPar>(
