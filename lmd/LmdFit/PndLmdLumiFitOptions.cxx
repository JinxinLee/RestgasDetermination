...
PndLmdLumiFitOptions::PndLmdLumiFitOptions(unsigned long bit_flag_options,
    int smearing_type_, int acc_intpol_type_, double plab,
    double theta_fit_range_low_, double theta_fit_range_high_,
    double phi_fit_range_low_, double phi_fit_range_high_) :
    binary_options(bit_flag_options), smearing_type(smearing_type_), acc_intpol_type(
        acc_intpol_type_) {
...
int PndLmdLumiFitOptions::getAcceptanceInterpolationType() {
