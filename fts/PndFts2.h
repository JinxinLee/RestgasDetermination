...
class PndFts2 : public FairDetector
{
 ...
 private:
   ...
   **/
  PndFtsPoint* AddHit(Int_t trackID, Int_t detID,  Int_t tubeID,Int_t chamberID, Int_t layerID,
  ...
  PndFts2& operator= (const  PndFts2&) {return *this;}
...
inline void PndFts2::ResetParameters() {
