...
#ifndef PNDFTSKALMANTASK_HH
#define PNDFTSOKALMANTASK_HH
...
class PndFtsKalmanTask : public FairTask {
public:

  // Constructors/Destructors ---------
  PndFtsKalmanTask(const char* name = "GenfitForward", Int_t iVerbose = 0);
    ~PndFtsKalmanTask();
