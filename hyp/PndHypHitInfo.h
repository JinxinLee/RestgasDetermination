 ...
 ** Class for additional information about MvdHit
...
#ifndef PNDHYPHITINFO_H
#define PNDHYPHITINFO_H 1


#include "TObject.h"


class PndHypHitInfo: public TObject 
{
 ...
 public:
  ...
  PndHypHitInfo(Int_t fileNumber, Int_t eventNumber, Int_t trackID,
