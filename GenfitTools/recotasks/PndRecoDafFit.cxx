...
Bool_t PndRecoDafFit::Init()
{
  ...
  if (fMvdBranchName == "Mix")
      ...
      if(stripar!=0)
	{
	  ...
	  std::cout << "*** PndRecoDafFit::Init" << "\t" << "MVDHitsStripMix array  found" << std::endl;
	}
	...
	{ 
	  ...
	  std::cout << "*** PndRecoDafFit::Init" << "\t" << "MVDHitsPixelMix array  found" << std::endl;
	}
    }
  else
    {
      ...
      if(stripar!=0)
	{
	  ...
	  std::cout << "*** PndRecoDafFit::Init" << "\t" << "MVDHitsStrip array  found" << std::endl;
	}
	...
	{ 
	  ...
	  std::cout << "*** PndRecoDafFit::Init" << "\t" << "MVDHitsPixel array  found" << std::endl;
	}
    }
  ...
  if (fCentralTrackerBranchName == "")
      ...
      if(sttr!=0)
	{
	  ...
	  std::cout << "*** PndRecoDafFit::Init" << "\t" << "SttHelixHit array  found" << std::endl;
	}
    }
  ...
  if (fCentralTrackerBranchName == "Mix")
      ...
      if(sthit!=0)
	{
	  ...
	  std::cout << "*** PndRecoDafFit::Init" << "\t" << "STTHitMix array  found" << std::endl;
	}
    }
  else
    {
      ...
      if(sthit!=0)
	{
	  ...
	  std::cout << "*** PndRecoDafFit::Init" << "\t" << "SttHit array  found" << std::endl;
	}
    }
  ...
  if(mdtar!=0)
    {
      ...
      std::cout << "*** PndRecoDafFit::Init" << "\t" << "MdtHit array  found" << std::endl;
    }
