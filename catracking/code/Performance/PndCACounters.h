...
#ifndef PNDCACOUNTERS_H
#define PNDCACOUNTERS_H
...
struct PndCAEfficiencies: public TEfficiencies
{
  PndCAEfficiencies():TEfficiencies(){
...
class PndCAPerformanceMCTrackData{
  public:
...
class PndCAPerformanceRecoTrackData{
  public:
