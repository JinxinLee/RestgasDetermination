...
#ifndef PNDCATRACKLINEARISATION_H
#define PNDCATRACKLINEARISATION_H
 ...
 *
 * PndCATrackLinearisation class describes the parameters which are used
 ...
 * the track trajectory itself (PndCATrackLinearisation = PndCATrackParam ).
 *
 */
class PndCATrackLinearisation
{
...
inline PndCATrackLinearisation::PndCATrackLinearisation( const PndCATrackParam &t )
...
inline void PndCATrackLinearisation::Set( float SinPhi1, float CosPhi1,
