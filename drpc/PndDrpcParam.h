...
#ifndef PNDDRPCPARAM_H
#define PNDDRPCPARAM_H
...
class PndDrpcParam : public TNamed
{
public:
  /** This is ROOT requirement **/
  PndDrpcParam() {};
  /** Text file constructor **/
  PndDrpcParam(const char* name, const char* filename);	
  virtual ~PndDrpcParam();
  ...
  Bool_t Differs(const PndDrpcParam* info) const;
private:
