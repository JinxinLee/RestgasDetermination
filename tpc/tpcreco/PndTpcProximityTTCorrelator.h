...
#ifndef TPCPROXIMITYTTCORRELATOR_HH
#define TPCPROXIMITYTTCORRELATOR_HH
...
class PndTpcProximityTTCorrelator : public PndTpcAbsTrackTrackCorrelator {
public:

  // Constructors/Destructors ---------
  PndTpcProximityTTCorrelator(double proxcut);
  ~PndTpcProximityTTCorrelator(){;}
