...
class PndTpcPlanarRecoHit : public PlanarRecoHit {
public:

  // Constructors/Destructors ---------
  PndTpcPlanarRecoHit();
  PndTpcPlanarRecoHit(double x, double y, double z,
	       double sigx, double sigy);
  PndTpcPlanarRecoHit(const TVector3& pos,
	       double sigx, double sigy);
  PndTpcPlanarRecoHit(PndTpcCluster* cl);

  virtual ~PndTpcPlanarRecoHit();
...
public:
  ClassDef(PndTpcPlanarRecoHit,1)
