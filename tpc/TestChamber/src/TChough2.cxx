...
TChough2::TChough2(const TVector3& _yp,const TVector3& _zp,double _r1,double _r2) : TCabsHough(_yp,_zp){
  r1Y=_r1;
  r2Y=_r2;
  thetaMin=0;
...
void TChough2::draw(bool stop,int _x,int _y,int _w,int _h){
  double x[ypHit.size()];
  double y[ypHit.size()];
...
void TChough2::findMaxInHisto(double& amax,double& bmax) {
...
int TChough2::binWeight(int ia, int ib, int ihit) {
