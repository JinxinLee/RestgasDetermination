  ...
  */  
  ...
  for(int i_ev=0;i_ev<nEvents;i_ev++) {
    ...
    std::vector<TCcluster> clGM2Y;
     ...
     for(unsigned int i=1;i<startClusters.size()/2;i++){
       int id =2*i-1;
     ...
     for(unsigned int i=1;i<endClusters.size()/2;i++){
       int id =2*i-1;
