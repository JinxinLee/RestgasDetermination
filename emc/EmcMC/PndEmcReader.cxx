...
void PndEmcReader::fill_vector()
{
	...
	while(f) {
	    ...
	    f>>data.module>>data.row>>data.crystal>>data.theta>>data.phi>>data.tau>>data.posX>>data.posY>>data.posZ>>data.pDz
	     >>data.pTheta>>data.pPhi>>data.pDy1>>data.pDx1>>data.pDx2>>data.pAlp1>>data.pDy2>>data.pDx3>>data.pDx4>>data.pAlp2;
