...
// Constructors --
//----------------
PndEmcCorrection::PndEmcCorrection(Int_t chosenModule, Double_t EnCorPhoton, Double_t EnCorElectron, 
				   Double_t EnCorPion, Double_t EnCorOther, Double_t ThCorPhoton, 
				   Double_t ThCorElectron, Double_t ThCorPion, Double_t ThCorOther, 
				   Double_t valzEnPhoton, Double_t valzEnElectron, Double_t valzEnPion, 
				   Double_t valzEnOther, Double_t valzThPhoton, Double_t valzThElectron, 
				   Double_t valzThPion, Double_t valzThOther)
  :
  fChosenModule(chosenModule),

  fEnergyCorrPhoton(EnCorPhoton),
  fEnergyCorrElectron(EnCorElectron),
  fEnergyCorrPion(EnCorPion),
  fEnergyCorrOther(EnCorOther),

  fThetaCorrPhoton(ThCorPhoton),
  fThetaCorrElectron(ThCorElectron),
  fThetaCorrPion(ThCorPion),
  fThetaCorrOther(ThCorOther),

  fEnCorrFactorPhoton(valzEnPhoton),
  fEnCorrFactorElectron(valzEnElectron),
  fEnCorrFactorPion(valzEnPion),
  fEnCorrFactorOther(valzEnOther),

  fThCorrFactorPhoton(valzThPhoton),
  fThCorrFactorElectron(valzThElectron),
  fThCorrFactorPion(valzThPion),
  fThCorrFactorOther(valzThOther)
{
}
