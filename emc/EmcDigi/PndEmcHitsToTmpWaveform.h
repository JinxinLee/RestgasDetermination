...
//----------------------------------------------------------------------
#pragma once
#ifndef PndEmcHitsToTmpWaveform_H
#define PndEmcHitsToTmpWaveform_H
...
public:
  ...
  PndEmcHitsToTmpWaveform(Int_t verbose=0, Bool_t storewaves=kTRUE);

  // Destructor

  virtual ~PndEmcHitsToTmpWaveform();
...
private:
  ...
  ClassDef(PndEmcHitsToTmpWaveform,1);
};
