...
Double_t
PndEmcXClMoments::SecondMoment() const
{
	Double_t r,sum=0;
...
Double_t 
PndEmcXClMoments::SecondMomentPhi() const
{
	Double_t r,sum=0;
	for (int i=0; i<fClusterSize; i++) 
	{
...
Double_t 
PndEmcXClMoments::SecondMomentTheta() const
{
	Double_t r,sum=0;
	for (int i=0; i<fClusterSize; i++) 
	{
...
Double_t 
PndEmcXClMoments::AbsZernikeMoment(int n, int m, Double_t R0) const
{
...
Double_t 
PndEmcXClMoments::f20(Double_t r) const { return 2.0*r*r-1.0; }

Double_t 
PndEmcXClMoments::f22(Double_t r) const { return r*r; }

Double_t 
PndEmcXClMoments::f31(Double_t r) const { return 3.0*r*r*r - 2.0*r; }

Double_t 
PndEmcXClMoments::f33(Double_t r) const { return r*r*r; }

Double_t 
PndEmcXClMoments::f40(Double_t r) const { return 6.0*r*r*r*r-6.0*r*r+1.0; }

Double_t 
PndEmcXClMoments::f42(Double_t r) const { return 4.0*r*r*r*r-3.0*r*r; }

Double_t 
PndEmcXClMoments::f44(Double_t r) const { return r*r*r*r; }

Double_t 
PndEmcXClMoments::f51(Double_t r) const { return 10.0*pow(r,5)-12.0*pow(r,3)+3.0*r; }

Double_t 
PndEmcXClMoments::f53(Double_t r) const { return 5.0*pow(r,5) - 4.0*pow(r,3); }

Double_t 
PndEmcXClMoments::f55(Double_t r) const { return pow(r,5); }

Double_t
PndEmcXClMoments::Fast_AbsZernikeMoment(int n, int m, Double_t R0)  const
{
...
Double_t
PndEmcXClMoments::Calc_AbsZernikeMoment(int n, int m, Double_t R0)  const
{
...
Double_t
PndEmcXClMoments::Fak(int n) const 
{
	Double_t res=1.0;
	for (int i=2; i<=n; i++) 
	{
