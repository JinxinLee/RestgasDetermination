...
#ifndef PNDSDSGEOHANDLING_H
#define PNDSDSGEOHANDLING_H
...
class PndSdsGeoHandling{
public:
    PndSdsGeoHandling();
    //PndSdsGeoHandling(TString fileName);
    PndSdsGeoHandling(TGeoManager* aGeoMan)
    { if (aGeoMan == 0) std::cout << "-E- PndSdsGeoHandling: Not a valid GeoManager" << std::endl;
      fGeoMan = aGeoMan;};
