...
double PndSdsChargeWeightingAlgorithms::center_of_gravity(const PndSdsCluster& Cluster)
{
   double result;
...
double PndSdsChargeWeightingAlgorithms::head_tail(const PndSdsCluster& Cluster)
{
   double result;
   int nrHits = Cluster.GetClusterSize();
   if(nrHits>1)
...
double PndSdsChargeWeightingAlgorithms::binary(const PndSdsCluster& Cluster)
{
   int nrHits = Cluster.GetClusterSize();
   double charge=0.;
   double channel=0;
...
double PndSdsChargeWeightingAlgorithms::eta(const PndSdsCluster& Cluster)
{
...
double PndSdsChargeWeightingAlgorithms::auto_select(const PndSdsCluster& Cluster)
{
