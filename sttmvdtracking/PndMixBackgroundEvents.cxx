...
//			FairRootManager::Instance()->GetBranchId("MVDHitsPixel"),
			...
			pos,
			dpos,
			pMvdPixelHit->GetClusterIndex(),
			pMvdPixelHit->GetCharge(),
			pMvdPixelHit->GetNDigiHits(),
			pMvdPixelHit->GetRefIndex()
			);
...
//			FairRootManager::Instance()->GetBranchId("MVDHitsStrip"),
			...
			pos,
			dpos,
			pMvdStripHit->GetClusterIndex(),
			pMvdStripHit->GetCharge(),
			pMvdStripHit->GetNDigiHits(),
			pMvdStripHit->GetRefIndex()
			);
