...
PndPatternDBGenerator::PndPatternDBGenerator() {
  ...
  foutputFile = NULL;
  fsectorPatternTree = NULL;
  ftrackPatternTree = NULL;
  bPattern = NULL;
...
//  Get instance of the FairRootManager to access tree branches
  ...
  if(!ioman) {
    std::cout << "-E- PndPatternDBGenerator::Init: FairRootManager not instantiated!" << std::endl;
    return kFATAL;
  }
...
//  Get the EventHeader
  ...
  if(!fEventHeader) {
    std::cout << "-E- PndPatternDBGenerator::Init: EventHeader not loaded!" << std::endl;
    return kFATAL;
  }
