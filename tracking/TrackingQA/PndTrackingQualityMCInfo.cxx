...
PndTrackingQualityMCInfo::PndTrackingQualityMCInfo() :  fNofMvdPixelPoints(0),  fNofMvdStripPoints(0), fNofSttParalPoints(0), fNofSttSkewPoints(0),
		fNofGemPoints(0), fNofFtsPoints(0), fReconstructabilityStatus(-1), fMCTrackID(-1), fRecoTrackIDs(),
		fPosFirst(TVector3(0., 0., 0.)), fMomFirst(TVector3(0., 0., 0.)),  fPosLast(TVector3(0., 0., 0.)), fMomLast(TVector3(0., 0., 0.)),
		fCharge(0), fIsPrimary(kFALSE), fVertex(TVector3(-10000.,-10000.,-10000.)), fMomentum(TVector3(-10000.,-10000.,-10000.)), fPDGCode(-1), fQuality(0.), fMCQuality(0), fAssoRecoTrackID(-1) {}
...
PndTrackingQualityMCInfo::PndTrackingQualityMCInfo(int nofmvdpix, int nofmvdstr, int nofsttparal, int nofsttskew, int nofgem, int noffts) :
		...
		fMomLast(TVector3(0., 0., 0.)), fCharge(0), fIsPrimary(kFALSE), fVertex(TVector3(-10000.,-10000.,-10000.)), fMomentum(TVector3(-10000.,-10000.,-10000.)), fPDGCode(-1), fQuality(0.), fMCQuality(0), fAssoRecoTrackID(-1) {}

PndTrackingQualityMCInfo::PndTrackingQualityMCInfo(const PndTrackingQualityMCInfo &info) : TObject(info), fNofMvdPixelPoints(0),  fNofMvdStripPoints(0), fNofSttParalPoints(0),
		fNofSttSkewPoints(0), fNofGemPoints(0), fNofFtsPoints(0), fReconstructabilityStatus(-1), fMCTrackID(-1), fRecoTrackIDs(), fPosFirst(TVector3(0., 0., 0.)),
		fMomFirst(TVector3(0., 0., 0.)), fPosLast(TVector3(0., 0., 0.)), fMomLast(TVector3(0., 0., 0.)), fCharge(0), fIsPrimary(kFALSE), fVertex(TVector3(-10000.,-10000.,-10000.)), fMomentum(TVector3(-10000.,-10000.,-10000.)), fPDGCode(-1), fQuality(0.), fMCQuality(0),
		fAssoRecoTrackID(-1) {
  *this = info;
}
