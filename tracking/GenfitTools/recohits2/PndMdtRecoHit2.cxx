...
TRandom3 PndMdtRecoHit2::rand(0);

PndMdtRecoHit2::~PndMdtRecoHit2()
{}

PndMdtRecoHit2::PndMdtRecoHit2()
  : genfit::SpacepointMeasurement(NparHitRep), fHit(NULL)
{}

PndMdtRecoHit2::PndMdtRecoHit2(double x, double y, double z,
  ...
  : genfit::SpacepointMeasurement(NparHitRep), fHit(NULL)
{
  if(!smear){
    ...
    rawHitCoords_[0] = rand.Gaus(pos.X(),sig.X());
    rawHitCoords_[1] = rand.Gaus(pos.Y(),sig.Y());
    rawHitCoords_[2] = rand.Gaus(pos.Z(),sig.Z());
  }
...
PndMdtRecoHit2::PndMdtRecoHit2(PndMdtHit* hit, const genfit::TrackCandHit* candHit)
  : genfit::SpacepointMeasurement(NparHitRep)
{
