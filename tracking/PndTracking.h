#ifndef PndTracking_H
#define PndTracking_H 1
...
class PndTracking : public FairTask
{
 ...
 public:
  ...
  /** Second constructor **/
  PndTracking(Int_t verbose);

  /** Third constructor **/
  PndTracking(int istamp, bool  iplot, bool doMcComparison);

  /** Fourth constructor **/
  PndTracking(int istamp, bool  iplot, bool doMcComparison, bool doSciTil);
 ...
 private:
  ...
  UShort_t
	...
	// possible only 1 or 2 hits.
	ListSciTilHitsinTrack[MAXTRACKSPEREVENT][MAXSCITILHITSINTRACK],// possible only 1 or 2 hits.
	ListTrackCandHit[MAXTRACKSPEREVENT][MAXSTTHITSINTRACK+
  ...
  Short_t
	...
	ListTrackCandHitType[MAXTRACKSPEREVENT][MAXSTTHITSINTRACK+  //  type = 0 --> Mvd Pixel
	MAXMVDPIXELHITSINTRACK+	//  type = 1 --> Mvd Strip
	MAXMVDSTRIPHITSINTRACK+MAXSCITILHITSINTRACK];	//  type = 2 --> Stt Parallel
		//  type = 3 --> Stt Straw
		//  type 1001 --> SciTil
		//  type -1 -->  noise
  int istampa, IVOLTE ;
