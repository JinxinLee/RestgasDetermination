...
public:
	...
	virtual void Print() const{
		...
		std::cout << "fParabolaStepsPerThetaDeg=" << fParabolaStepsPerThetaDeg
...
private:
	// parabola theta
	Double_t fParabolaStepsPerThetaDeg; // how many scan steps should the Hough transform do per degree in theta when searching for the parabola - greater number means finer scanning in theta (will multiplied and rounded lateron)
