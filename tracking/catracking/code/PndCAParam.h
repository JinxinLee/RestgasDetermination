...
//   friend std::ostream &operator<<( std::ostream &, const PndCAParam & );
 public:
  ...
  float_v GetXOverX0( int_v iSt, float_m mask ) const { float_v r; r.gather( fStations, &PndCAStation::xOverX0, static_cast<uint_v>(iSt), mask ); return r; };
  float_v GetXTimesRho( int_v iSt, float_m mask ) const { float_v r; r.gather( fStations, &PndCAStation::xTimesRho, static_cast<uint_v>(iSt), mask ); return r; };
  float_v GetR( int_v iSt, const float_m& mask ) const { float_v r; r.gather( fStations, &PndCAStation::r, static_cast<uint_v>(iSt), mask ); return r; }
