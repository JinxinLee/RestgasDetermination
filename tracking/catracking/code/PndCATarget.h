...
class PndCATarget {
 public:
  ...
  PndCATarget( float x0, float x1, float x2, float dx1, float dx2, float dqmom, PndCAFieldValue b, int ndf ):fX0(x0), fX1(x1), fX2(x2), fDX1(dx1), fDX2(dx2), fDQMom(dqmom), fB(b), fNDF(ndf) {};
