...
void  PndCATrackParamVector::GetDCAPoint( const float_v &x, const float_v &y, const float_v &z,
...
float_m PndCATrackParamVector::TransportToX( const float_v &x, const float_v &Bz,
...
float_m PndCATrackParamVector::TransportToXWithMaterial( const float_v &x,  PndCATrackFitParam &par, const float_v &XOverX0,
...
float_m PndCATrackParamVector::TransportToXWithMaterial( const float_v &x, const float_v &XOverX0,
const float_v &XThimesRho, const float_v &Bz, const float maxSinPhi )
{
  //* Transport the track parameters to X=x taking into account material budget
...
float_v PndCATrackParamVector::BetheBlochGeant( const float_v &bg2,
    const float_v &kp0,
    const float_v &kp1,
    const float_v &kp2,
    const float_v &kp3,
...
float_m PndCATrackParamVector::Rotate( const float_v &alpha, PndCATrackLinearisationVector &t0,
                                              const float maxSinPhi, const float_m &mask )
{
...
float_m PndCATrackParamVector::FilterWithMaterial( const float_v &y, const float_v &z, float_v err2Y, float_v errYZ, float_v err2Z, float maxSinPhi, const float_m &mask, const int_v& hitNDF, const float_v& chi2Cut )
{
...
float_m PndCATrackParamVector::FilterWithMaterial( const float_v &y, const float_v &z, const PndCAStripInfo &info, float_v err2, float maxSinPhi, const float_m &mask, const float_v& chi2Cut )
...
float_m PndCATrackParamVector::AcceptWithMaterial( const float_v &y, const float_v &z, float_v err2Y, float_v errYZ, float_v err2Z, float maxSinPhi, const float_m &mask, const int_v& /*hitNDF*/, const float_v& chi2Cut ) const
{
  assert( maxSinPhi > 0.f );
  //* Add the y,z measurement with the Kalman filter
...
float_m PndCATrackParamVector::AcceptWithMaterial( const float_v &y, const float_v &z, const PndCAStripInfo &info, float_v err2, float maxSinPhi, const float_m &mask, const float_v& chi2Cut ) const
    //* Adds the 1-D measurement with the Kalman filter
    //* @beta is angle between the strip and z-axis, clockwise
{
  assert( maxSinPhi > 0.f );
