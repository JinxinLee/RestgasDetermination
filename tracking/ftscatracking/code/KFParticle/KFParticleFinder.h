...
class KFParticleFinder
{
 public:
  ...
  /// cut[*][3] - chi2/ndf of the reconstructed particle fitted to the PV;
    ...
    static void FindParticles(std::vector<KFPTrack>& vRTracks, std::vector<float>& ChiToPrimVtx,
#ifdef NonhomogeniousField
    ...
    static void Find2DaughterDecay(std::vector<KFPTrack>& vTracks,
#ifdef NonhomogeniousField
  ...
  static void FindHyperons(int PDG,
    ...
    static void FindDMesLambdac(std::vector<KFPTrack>& vTracks,
#ifdef NonhomogeniousField
                                const std::vector<L1FieldRegion>& vField,
#endif
                                std::vector<KFParticle>& Particles,
    ...
    static void CombineTrackPart(std::vector<KFPTrack>& vTracks,
#ifdef NonhomogeniousField
                                 const std::vector<L1FieldRegion>& vField,
#endif
                                 std::vector<KFParticle>& Particles,
