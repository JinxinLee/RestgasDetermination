...
class PndFTSCAClusterData
{
  public:
    ...
    void readEvent( const PndFTSArray<PndFTSSpacePointData *> &clusters,
...
typedef PndFTSCAClusterData ClusterData;
