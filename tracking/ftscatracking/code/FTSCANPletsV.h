...
class FTSCANPletV {
 ...
 public:
  ...
  FTSCANPletV( const FTSCANPletV& s1, const PndFTSCATrackParamVector& param, const float_m isValid ):fParam(param), fIsValid(isValid) 
  {
    fNHits = s1.N() + 1;
  }
