...
class PndFTSCADisplay::PndFTSCADisplayTmpHit
{
  ...
  public:
    ...
    static bool CompareHitDS( const PndFTSCADisplayTmpHit &a,
                                const PndFTSCADisplayTmpHit  &b ) {
      return ( a.fS < b.fS );
    }

    static bool CompareHitZ( const PndFTSCADisplayTmpHit &a,
                               const PndFTSCADisplayTmpHit  &b ) {
      return ( a.fZ < b.fZ );
    }
...
bool PndFTSCADisplay::DrawTrack( PndFTSCATrackParam t, double Alpha, const PndFTSCADisplayTmpHit *vHits,
