...
cout << " **************** Param before Refit_1 ************ " << endl;
  ...
  cout << " param.Tx()[0] " << param.Tx()[0] 
     << " param.Ty()[0] " << param.Ty()[0]
      << " param.QP()[0] " <<  param.QP()[0]
      << " param.X()[0] " << param.X()[0]
       << " param.Y()[0] " << param.Y()[0]
       << " param.Z()[0] " << param.Z()[0]
       << " param.Chi2()[0] " << param.Chi2()[0]
        << " param.NDF()[0] " << param.NDF()[0] << endl;
...
float By_MC = (hit_1.point_Y - (hit_1.point_Py/hit_1.point_Pz)*hit_1.point_Z);
 float R_MC = (c*(Tx_MC*hit.X0()+ Bx_MC - hit.X1()) 
+ s*(Ty_MC*hit.X0()+ By_MC - hit.X2()) )/sqrt(1.f + (c*Tx_MC + s*Ty_MC)*(c*Tx_MC + s*Ty_MC)); 
...
cout << " D2_mc_hit " << D2_mc_hit <<  " hit.R() " << hit.R() <<  
...
float R_MC_1 = (c*(Tx_MC*hit_1.point_Z + Bx_MC - hit.X1())
    + s*(Ty_MC*hit_1.point_Z+ By_MC - hit.X2()) )/sqrt(1.f + (c*Tx_MC + s*Ty_MC)*(c*Tx_MC + s*Ty_MC));
...
float R_MC_2 = (c*(hit_1.point_X  - hit.X1())
    + s*(hit_1.point_Y - hit.X2()) )/sqrt(1.f + (c*Tx_MC + s*Ty_MC)*(c*Tx_MC + s*Ty_MC));
