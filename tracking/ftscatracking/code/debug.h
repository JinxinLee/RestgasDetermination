...
static class PndFTSCANoDebugStream {
  public:
      ...
      template<typename T>
      inline PndFTSCANoDebugStream &operator<<( const T & ) { return *this; }
...
#else
inline PndFTSCANoDebugStream &debugS() { return PndFTSCANoDebugStreamInst; }
#endif
#if DEBUG_MESSAGES & 2
inline std::ostream &debugF() { return std::cerr; }
#else
inline PndFTSCANoDebugStream &debugF() { return PndFTSCANoDebugStreamInst; }
#endif
#if DEBUG_MESSAGES & 4
inline std::ostream &debugKF() { return std::cerr; }
#else
inline PndFTSCANoDebugStream &debugKF() { return PndFTSCANoDebugStreamInst; }
#endif
#if DEBUG_MESSAGES & 8
inline std::ostream &debugTS() { return std::cerr; }
#else
inline PndFTSCANoDebugStream &debugTS() { return PndFTSCANoDebugStreamInst; }
#endif
#if DEBUG_MESSAGES & 16
inline std::ostream &debugWO() { return std::cerr; }
#else
inline PndFTSCANoDebugStream &debugWO() { return PndFTSCANoDebugStreamInst; }
#endif
#else
