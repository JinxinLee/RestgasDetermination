...
void PndSttCellTrackletGenerator::CombineTrackletsMultiStagesRecursive(
...
PndRiemannTrack PndSttCellTrackletGenerator::CreateRiemannTrack(
		vector<int> hitIDs) {
