 ...
 ** Class for additional information about PndMvdHit
...
#ifndef PNDMVDHITINFO_H
#define PNDMVDHITINFO_H 1


#include "TObject.h"


class PndMvdHitInfo: public TObject 
{
 ...
 public:
  ...
  PndMvdHitInfo(Int_t fileNumber, Int_t eventNumber, Int_t trackID,
		Int_t pointID, Int_t nMerged, Bool_t isFake);


  /** Destructor **/
  virtual ~PndMvdHitInfo();  
