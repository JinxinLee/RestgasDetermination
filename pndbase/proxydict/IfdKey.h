...
//    $Id: IfdKey.h,v 1.1.1.1 2005/03/29 17:13:30 steinke Exp $
//
// Description:
...
//
//  Reading IntIfdKey.h after this is helpful.  Then tackle CompositeIfdKey.h
//
...
protected:
   ...
   inline IfdKey::keyKind getKeyKind( void ) const { return _myKeyKind; }
      ...
      // The enum allows us to .cxxess the union correctly.  If we
   ...
   keyKind _myKeyKind;
      ...
      // .cxxessor to _myKeyKind and we set _myKeyKind in the ctors.
