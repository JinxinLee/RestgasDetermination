...
ClassImp(RhoKinHyperonVtxFitter)

TBuffer& operator>>(TBuffer& buf, RhoKinHyperonVtxFitter *&obj)
{
  obj = (RhoKinHyperonVtxFitter*) buf.ReadObject(RhoKinHyperonVtxFitter::Class());
  return buf;
}
...
// void RhoKinHyperonVtxFitter::AddPointingConstraint(TVector3 pVtx)
// {
//   fPointConstraint = 1;
//   fpVtx=pVtx;
// }
...
Bool_t RhoKinHyperonVtxFitter::FitNode(RhoCandidate *cand)
{
...
//unsigned RhoKinHyperonVtxFitter:: ReadKinMatrix( TMatrixD & mD,  TMatrixD & mE, TMatrixD & md)
...
// unsigned RhoKinHyperonVtxFitter:: ReadMassKinMatrix( TMatrixD & mD,  TMatrixD & mE,  TMatrixD & md)
{
...
// not used yet?
// void RhoKinHyperonVtxFitter::ReadPointingKinMatrix(RhoCandidate* head)
// {
