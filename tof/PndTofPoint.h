// ------------------------------------------------------------------------
// -----                     PndTofpoint header file                  -----
// -----               Created by A.Sanchez                 -----
// ------------------------------------------------------------------------

#ifndef PNDTOFPOINT_H
#define PNDTOFPOINT_H
...
class PndTofPoint : public FairMCPoint 
{
 ...
 public:
  ...
  /** Copy constructor **/
  PndTofPoint(const PndTofPoint& point) { *this = point; };
 ...
 protected:
  ...
  ClassDef(PndTofPoint,1)

};

inline void PndTofPoint::SetPositionIn(const TVector3& pos) {
  fXin = pos.X();
  fYin = pos.Y();
  fZin = pos.Z();
}

inline void PndTofPoint::SetMomentumIn(const TVector3& mom) {
  fPxin = mom.X();
  fPyin = mom.Py();
  fPzin = mom.Pz();
}

inline void PndTofPoint::SetPositionOut(const TVector3& pos) {
  fXout = pos.X();
  fYout = pos.Y();
  fZout = pos.Z();
}

inline void PndTofPoint::SetMomentumOut(const TVector3& mom) {
  fPxout = mom.Px();
  fPyout = mom.Py();
  fPzout = mom.Pz();
}
