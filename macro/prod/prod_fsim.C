...
void prod_fsim(TString Prefix="", Int_t nEvents = 1000, TString Decfile="", Float_t Mom=0., TString Resonance="pbarpSystem0" )
{
...
// 	if (DetOpt.Contains("FwdSpec") || DetOpt.Contains("5") ) SwFwdSpec = true;
	...
	Bool_t persist           = true;  // we just want to keep SoftTrigger Output
