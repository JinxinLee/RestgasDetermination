...
*/  
  ...
  if(UseBoxGenerator){	// Box Generator
     FairBoxGenerator* boxGen = new FairBoxGenerator(50000050, 10); // 13 = muon; 1 = multipl.
     boxGen->SetPRange(mom,mom); // GeV/c
     boxGen->SetPhiRange(13., 13.); // Azimuth angle range [degree]
     boxGen->SetThetaRange(110., 110.); // Polar angle in lab system range [degree]
     boxGen->SetXYZ(49.8906, 11.6258, 0.); // mm o cm ??
