...
// This macro is supposed to run the full simulation of the panda detectorwith the TPC option
// to run the macro:
// root  sim_complete_tpc.C  or in root session root>.x  sim_complete_tpc.C
// to run with different options:(e.g more events, different momentum, Geant4)
// root  sim_complete_tpc.C"(100, "TGeant4",2)"
