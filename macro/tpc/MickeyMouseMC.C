{
  ...
  // Output file
  TString outFile = "MickeyMouseMCMACBETH.root";
...
MickeyMouseMCTask *myMickeyMouseMC= new MickeyMouseMCTask();
myMickeyMouseMC->SetPersistence();
fRun->AddTask(myMickeyMouseMC);

//TrackVisTask *trackVis= new TrackVisTask();
//trackVis->SetTrackBranchName("TrackMickeyMouseMC");
//fRun->AddTask(trackVis);
    
//FitStatTask *fitStat= new FitStatTask();
//fitStat->SetTrackBranchName("TrackMickeyMouseMC");
