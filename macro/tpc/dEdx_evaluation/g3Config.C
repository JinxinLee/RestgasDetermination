...
void Config()
{
  ...
  // ******* GEANT3  specific configuration for simulated Runs  *******
    cout << "SETTING MAXNSTEPS: current value is " << geant3->GetMaxNStep() << endl;
    geant3->SetMaxNStep(1000000);
    cout << "\n*** NEW VALUE: " << geant3->GetMaxNStep() << endl; cout.flush();
    ...
    //felix' mod
    geant3->SetSTRA(0);
    geant3->SetLOSS(5);         //creepy viola parameter, value 5 is hidden/unofficial
