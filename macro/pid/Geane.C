...
void Config()
{
  ...
  o->SetParam(3, .05); // stemax=0.01 cm
  TGeoMedium *n=gGeoManager->GetMedium("PWO");
  n->SetParam(3, .05); // stemax=0.01 cm
  //TGeoMedium *m=gGeoManager->GetMedium("TPCmixture");
  //m->SetParam(3, .01); // stemax=0.01 cm
