...
void gem_material_ana1(int nEvents = 10000, bool verbose = false)
{
// int nEvents = 100;
//  verbose  = true;
  bool draw1    = true;
...
//   gROOT->Macro("../Libs.C");
  ...
  //TString MCFile  =  "gem_mat_sim.root";
  //TString MCFile  =  "gem_mat_sim2.root";
  //TString MCFile  =  "gem_mat_sim3.root";
  //TString MCFile  =  "gem_mat_sim_withoutpipe.root";
  TString MCFile  =  "gem_mat_sim_GemPion.root";
  
  //TString parFile =  "gem_mat_simparams.root";
  //TString parFile =  "gem_mat_simparams2.root";
  //TString parFile =  "gem_mat_simparams3.root";
  //TString parFile =  "gem_mat_simparams_withoutpipe.root";
  TString parFile =  "gem_mat_simparams_GemPion.root";
...
//---------------------------------------------------------------------------------
  ...
  cout << "befoer maxnames loop" << endl;
  ...
  new ((*arrprothe)[maxnames]) TProfile("hthe-rest","Gemrest",angres,0.,TMath::Pi());
  new ((*arrprophi)[maxnames]) TProfile("hphi-rest","Gemrest",angres,-1.*TMath::Pi(),TMath::Pi());
  radlList[maxnames]=0.;
...
//  TH2D* histhephi = new TH2D("hThePhi","",100,0.2,TMath::Pi()-0.3,100,-1.*TMath::Pi(),TMath::Pi());
  TProfile2D* histhephi = new TProfile2D("hThePhi","",90,0.0,3.0,90,-1.*TMath::Pi(),TMath::Pi());
...
can2->cd(1);
thetastack->SetMaximum(1.6);
//thetastack->SetMaximum(7.8);
