...
{ // create only GEM with one station , create GEM last station at the ZPosition=188.50cm , (it is the biggest one )
  ...
  //----------------------------------------------------------------------------------------------------------------------------------------------
  // Done Some Changes By Nazila Divani-Veis ( since  May 2015 ... ) ---------> only for using third station of GEM
  //----------------------------------------------------------------------------------------------------------------------------------------------
  ...
  //---------------------------------------------------------------------------------------------------------------------------------------------
    ...
    const Double_t  kDiskVolOuterRadius[kNofDisks]    = {  74.0  };   // OuterRadius for one Station in form of disk
    const Double_t  kDiskZPosition  [kNofDisks]    = { 188.50 };   // ZPosition for one Station in form of disk           
 

    const Int_t     kDiskNFoils     [kNofDisks]    = {  4  };   // For modifying misalignment
    ...
    const Double_t carbonRingInnerRadius[kNofDisks]    = {  69.0 };
    const Double_t carbonRingOuterRadius[kNofDisks]    = {  69.2 };
    const Double_t carbonRingHalfThickness = 1.5;

    const Double_t copperRingInnerRadius[kNofDisks]    = {  68.9 };
    const Double_t copperRingOuterRadius[kNofDisks]    = {  69.1 };
    const Double_t copperRingHalfThickness = 3.75;

    const Double_t AlRingInnerRadius[kNofDisks]    = {  69.1 };
    const Double_t AlRingOuterRadius[kNofDisks]    = {  73.7 };
    ...
    const Double_t moduleRingInnerRadius[kNofDisks]    = {  69.15 };
    const Double_t moduleRingOuterRadius[kNofDisks]    = {  73.65 };
    ...
    const Double_t AlumiRingInnerRadius[kNofDisks]    = {  73.7 };
    const Double_t AlumiRingOuterRadius[kNofDisks]    = {  74.0 };
    const Double_t AlumiRingHalfThickness = 3.75;
    
    const Double_t coverRingInnerRadius[kNofDisks]    = {  68.9 };
    const Double_t coverRingOuterRadius[kNofDisks]    = {  74.0 };
  ...
  //------------------------------------------------------------ main layers in shape of Disk----------------------------------------------------------------------
   ...
   const Double_t kDiskOuterRadius[kNofLayers][kNofDisks] = {  67.95,      68.40,
							       68.90,
							       67.45,      68.40,     67.45,
							       68.40,
							       67.45,
...
//----------------------- holding structure layers ------------------------------------------------------------------------------------------------
    ...
    const Double_t  HZPosition[NofHLayers][kNofDisks] = {    -1.9426,  
                                                             ...
                                                             -0.0517,
                                                              ...
                                                              1.5417,
                                                              1.9426  }; 
   const Double_t HOuterRadius[NofHLayers][kNofDisks] = {       68.90,
                                                                68.40,
                                                                68.05,
                                                                68.05,
                                                                68.05,
                                                                ...
                                                                68.40,
                                                                68.90  };
    const Double_t HInnerRadius[NofHLayers][kNofDisks] = {      68.65,
                                                                67.50,
                                                                67.05,
                                                                67.05,
                                                                67.05,
   ...
   const Double_t  HTY[NofHLayers][kNofDisks] = { 45.0,   
                                                  45.0,
                                                  45.0,
                                                  45.0,
                                                  45.0,
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  TString outfile= "../../geometry/gem_1Station_last_realistic_v1.root"; // it means GEM with one station which is its' third station
 ...
 //----------------------------------------------------------------------------------------------
  TString outParFileName = Form("%s/macro/params/gem_1Station_last_realistic_v1.digi.par",vmcWorkdir.Data());
