...
Int_t create1StationGem_firstStation_v2()
{
  ...
  //----------------------------------------------------------------------------------------------------------------------------------------------
  // created GEM first station at the ZPosition=119.40cm , (This is the smallest GEM station)
  //----------------------------------------------------------------------------------------------------------------------------------------------
  ...
  //---------------------------------------------------------------------------------------------------------------------------------------------
    ...
    const Double_t  DiskVolOuterRadius[NofDisks]    = { 45.06  };  // OuterRadius for 1 Station in form of disk
    ...
    const Double_t  carbonRingInnerRadius[NofDisks]    = { 39.97 };
    const Double_t  carbonRingOuterRadius[NofDisks]    = { 40.17 };
    const Double_t  carbonRingHalfThickness = 1.50; 

    const Double_t  copperRingInnerRadius[NofDisks]    = { 39.47 };
    const Double_t  copperRingOuterRadius[NofDisks]    = { 39.67 };
    const Double_t  copperRingHalfThickness = 3.75;

    const Double_t  AlRingInnerRadius[NofDisks]    = { 39.70 };
    const Double_t  AlRingOuterRadius[NofDisks]    = { 44.70 };
    ...
    const Double_t moduleRingInnerRadius[NofDisks]    = { 39.70 };
    ...
    const Double_t coverRingInnerRadius[NofDisks]    = { 39.70 };
