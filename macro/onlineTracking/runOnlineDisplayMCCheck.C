...
void runOnlineDisplayMCCheck(Int_t maximumTime = 2050)  {
	gROOT->Reset();
	...
	TH1D* hphires = new TH1D("hphires", "hphires", 3000, -15, 15);
	TH2D* hptres = new TH2D("hptres", "hptres", 300, -1500, 1500, 200, -1, 1);
	TH1D* hphiresmc = new TH1D("hphiresmc", "hphiresmc", 3000, -15, 15);
	TH2D* hptresmc = new TH2D("hptresmc", "hptresmc", 300, -1500, 1500, 200, -1, 1);
	TH1D* hphiresmc90 = new TH1D("hphiresmc90", "hphiresmc90", 3000, -15, 15);
	TH2D* hptresmc90 = new TH2D("hptresmc90", "hptresmc90", 300, -1500, 1500, 200, -1, 1);
	TH1D* hphiresmc80 = new TH1D("hphiresmc80", "hphiresmc80", 3000, -15, 15);
	TH2D* hptresmc80 = new TH2D("hptresmc80", "hptresmc80", 300, -1500, 1500, 200, -1, 1);
	TH1D* hphiresmcbad = new TH1D("hphiresmcbad", "hphiresmcbad", 3000, -15, 15);
	TH2D* hptresmcbad = new TH2D("hptresmcbad", "hptresmcbad", 300, -1500, 1500, 200, -1, 1);
