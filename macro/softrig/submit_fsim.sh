...
38)
	...
	qsub -t $sigmin-$sigmax job_sof_fsim.sge 38103 $nevt decfiles/M103_D0stD0b.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof_fsim.sge 38104 $nevt decfiles/M104_D0stD0b.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof_fsim.sge 38105 $nevt decfiles/M105_D0stD0b.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof_fsim.sge 38106 $nevt decfiles/M106_D0stD0stb.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof_fsim.sge 38107 $nevt decfiles/M107_D0stD0stb.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof_fsim.sge 38108 $nevt decfiles/M108_D0stD0stb.dec $pmom $res
	...
	qsub -t $sigmin-$sigmax job_sof_fsim.sge 38124 $nevt decfiles/M124_DpstDm.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof_fsim.sge 38125 $nevt decfiles/M125_DpstDm.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof_fsim.sge 38126 $nevt decfiles/M126_DpstDm.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof_fsim.sge 38127 $nevt decfiles/M127_DpstDm.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof_fsim.sge 38128 $nevt decfiles/M128_DpstDmst.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof_fsim.sge 38129 $nevt decfiles/M129_DpstDmst.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof_fsim.sge 38130 $nevt decfiles/M130_DpstDmst.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof_fsim.sge 38131 $nevt decfiles/M131_DpstDmst.dec $pmom $res
