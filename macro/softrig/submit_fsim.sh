...
# 	qsub -t $sigmin-$sigmax job_sof_fsim.sge 55241 $nevt decfiles/M241_chic02pi.dec $pmom $res
	...
	qsub -t $sigmin-$sigmax job_sof_fsim.sge 55243 $nevt decfiles/M243_chic02pi.dec $pmom $res

	# h_c modes
	qsub -t $sigmin-$sigmax job_sof_fsim.sge 55260 $nevt decfiles/M260_hc2pi.dec $pmom $res
