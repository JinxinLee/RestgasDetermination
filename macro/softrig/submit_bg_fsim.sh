...
echo "Fsim BKG jobs: "$bgmin"-"$bgmax

case $energy in
# E_cm = 2.4 GeV, pbarmom = 1.913547
24)
	qsub -t $bgmin-$bgmax job_sof_fsim.sge 24900 $nevt DPM 1.913547 
	;;

# E_cm = 3.77 GeV, pbarmom = 6.56903
38)
	qsub -t $bgmin-$bgmax job_sof_fsim.sge 38900 $nevt DPM 6.56903 
	;;

# E_cm = 4.5 GeV, pbarmom = 9.808065
45)
	qsub -t $bgmin-$bgmax job_sof_fsim.sge 45900 $nevt DPM 9.808065
	;;

# E_cm = 5.5 GeV, pbarmom = 15.152765
55)
	qsub -t $bgmin-$bgmax job_sof_fsim.sge 55900 $nevt DPM 15.152765
	;;
