...
24)
	...
	# phi mode
	qsub -t $sigmin-$sigmax job_sof.sge 24000 $nevt decfiles/M000_2phi.dec $pmom $res

	# electro-magnetic modes
	qsub -t $sigmin-$sigmax job_sof.sge 24300 $nevt decfiles/M300_ee.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof.sge 24320 $nevt decfiles/M320_mumu.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof.sge 24340 $nevt decfiles/M340_gamgam.dec $pmom $res

	# Lambda mode
	qsub -t $sigmin-$sigmax job_sof.sge 24400 $nevt decfiles/M400_LamLamb.dec $pmom $res
...
38)
	...
	# phi mode
	qsub -t $sigmin-$sigmax job_sof.sge 38000 $nevt decfiles/M000_2phi.dec $pmom $res
...
#	qsub -t $sigmin-$sigmax job_sof.sge 38122 $nevt decfiles/M122_DpDm.dec $pmom $res
	...
	qsub -t $sigmin-$sigmax job_sof.sge 38201 $nevt decfiles/M201_Jpsi2pi.dec $pmom $res
...
# 	qsub -t $sigmin-$sigmax job_sof.sge 38222 $nevt decfiles/M222_etac2pi.dec $pmom $res
	...
	# electro-magnetic modes
	qsub -t $sigmin-$sigmax job_sof.sge 38300 $nevt decfiles/M300_ee.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof.sge 38320 $nevt decfiles/M320_mumu.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof.sge 38340 $nevt decfiles/M340_gamgam.dec $pmom $res

	# Lambda mode
	qsub -t $sigmin-$sigmax job_sof.sge 38400 $nevt decfiles/M400_LamLamb.dec $pmom $res
	;;
...
45)
	...
	# phi mode
	qsub -t $sigmin-$sigmax job_sof.sge 45000 $nevt decfiles/M000_2phi.dec $pmom $res

	# D0 modes
	qsub -t $sigmin-$sigmax job_sof.sge 45100 $nevt decfiles/M100_D0D0b.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof.sge 45101 $nevt decfiles/M101_D0D0b.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof.sge 45102 $nevt decfiles/M102_D0D0b.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof.sge 45103 $nevt decfiles/M103_D0stD0b.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof.sge 45104 $nevt decfiles/M104_D0stD0b.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof.sge 45105 $nevt decfiles/M105_D0stD0b.dec $pmom $res
...
#	qsub -t $sigmin-$sigmax job_sof.sge 45130 $nevt decfiles/M130_DpstDmst.dec $pmom $res
	...
	# Ds modes
	qsub -t $sigmin-$sigmax job_sof.sge 45140 $nevt decfiles/M140_DspDsm.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof.sge 45141 $nevt decfiles/M141_DspDsm.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof.sge 45142 $nevt decfiles/M142_DspstDsm.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof.sge 45143 $nevt decfiles/M143_DspstDsm.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof.sge 45144 $nevt decfiles/M144_DspstDsmst.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof.sge 45145 $nevt decfiles/M145_DspstDsmst.dec $pmom $res

	# J/psi modes
	qsub -t $sigmin-$sigmax job_sof.sge 45200 $nevt decfiles/M200_Jpsi2pi.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof.sge 45201 $nevt decfiles/M201_Jpsi2pi.dec $pmom $res
...
#	qsub -t $sigmin-$sigmax job_sof.sge 45241 $nevt decfiles/M241_chic02pi.dec $pmom $res
	...
	qsub -t $sigmin-$sigmax job_sof.sge 45320 $nevt decfiles/M320_mumu.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof.sge 45340 $nevt decfiles/M340_gamgam.dec $pmom $res

	# Lambda mode
	qsub -t $sigmin-$sigmax job_sof.sge 45400 $nevt decfiles/M400_LamLamb.dec $pmom $res
	;;
...
55)
	...
	# phi mode
	qsub -t $sigmin-$sigmax job_sof.sge 55000 $nevt decfiles/M000_2phi.dec $pmom $res

	# D0 modes
	qsub -t $sigmin-$sigmax job_sof.sge 55100 $nevt decfiles/M100_D0D0b.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof.sge 55101 $nevt decfiles/M101_D0D0b.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof.sge 55102 $nevt decfiles/M102_D0D0b.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof.sge 55103 $nevt decfiles/M103_D0stD0b.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof.sge 55104 $nevt decfiles/M104_D0stD0b.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof.sge 55105 $nevt decfiles/M105_D0stD0b.dec $pmom $res
...
#	qsub -t $sigmin-$sigmax job_sof.sge 55130 $nevt decfiles/M130_DpstDmst.dec $pmom $res
	...
	# Ds modes
	qsub -t $sigmin-$sigmax job_sof.sge 55140 $nevt decfiles/M140_DspDsm.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof.sge 55141 $nevt decfiles/M141_DspDsm.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof.sge 55142 $nevt decfiles/M142_DspstDsm.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof.sge 55143 $nevt decfiles/M143_DspstDsm.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof.sge 55144 $nevt decfiles/M144_DspstDsmst.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof.sge 55145 $nevt decfiles/M145_DspstDsmst.dec $pmom $res

	# J/psi modes
	qsub -t $sigmin-$sigmax job_sof.sge 55200 $nevt decfiles/M200_Jpsi2pi.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof.sge 55201 $nevt decfiles/M201_Jpsi2pi.dec $pmom $res
...
#	qsub -t $sigmin-$sigmax job_sof.sge 55241 $nevt decfiles/M241_chic02pi.dec $pmom $res
	...
	qsub -t $sigmin-$sigmax job_sof.sge 55320 $nevt decfiles/M320_mumu.dec $pmom $res
	qsub -t $sigmin-$sigmax job_sof.sge 55340 $nevt decfiles/M340_gamgam.dec $pmom $res

	# Lambda mode
	qsub -t $sigmin-$sigmax job_sof.sge 55400 $nevt decfiles/M400_LamLamb.dec $pmom $res

	# Lambda_c mode
	qsub -t $sigmin-$sigmax job_sof.sge 55420 $nevt decfiles/M420_LamcLamcb.dec $pmom $res
	;;
