...
#include <sstream>
using namespace std;
void GenAlignEffect(TString path="/data/FAIRsorf/pandaroot/trunk/macro/lmd/tmpOutputAlign/results/01062012/",double misalsc=0, int crGraph=0, double rot_scale=0, int poNum=10, TString resname="/data/FAIRsorf/pandaroot/trunk/macro/lmd/tmpOutputAlign/results/Sens")
{
  /// Theta resolution--------------------------------------------------------------------------------------  
 ...
 if (fresb->IsZombie()) {
   std::cout << "!!! Error opening file " <<nameresb<< std::endl;
   // return;
 }
 TFile *fresa = new TFile(nameresa,"READ");
 if (fresa->IsZombie()) {
   std::cout << "!!! Error opening file " <<nameresa<< std::endl;
   //return;
 }
 ...
 TFile *fres;
  ...
  if(crGraph<1){
    ...
    th_mean = new TGraphErrors(poNum);
    ...
    th_mean = (TGraphErrors*)fres->Get("th_mean");
  ...
  th_mean->SetPointError(crGraph,0,thSigma_a);
  ...
  if(crGraph==(poNum-1)){
    ...
    th_mean->GetXaxis()->SetTitle("translation misalignment scale, #mum");
    th_mean->GetYaxis()->SetTitle("Gaussian mean value, rad");
    th_mean->SetMarkerStyle(7);
    th_mean->Draw("AP");
    c1.Print(resname_pdf_o); //write canvas and keep the ps file open
    th_sigma->SetTitle("#theta Sigma");
    th_sigma->GetXaxis()->SetTitle("translation misalignment scale, #mum");
    th_sigma->GetYaxis()->SetTitle("Gaussian sigma value, rad");
    th_sigma->SetMarkerStyle(25);
    th_sigma->Draw("AP");
    c1.Print(resname_pdf_o); //write canvas and keep the ps file open
    resx_b->SetTitle("x residuals [before]");
    resx_b->GetXaxis()->SetTitle("translation misalignment scale, #mum");
    resx_b->GetYaxis()->SetTitle("x residuals, cm");
    resx_b->SetMarkerStyle(25);
    resx_b->Draw("AP");
    c1.Print(resname_pdf_o); //write canvas and keep the ps file open
    resx_a->SetTitle("x residuals [after]");
    resx_a->GetXaxis()->SetTitle("translation misalignment scale, #mum");
    resx_a->GetYaxis()->SetTitle("x residuals, cm");
    resx_a->SetMarkerStyle(25);
    resx_a->SetMarkerColor(2);
    resx_a->Draw("AP");
    c1.Print(resname_pdf_o); //write canvas and keep the ps file open
    resy_b->SetTitle("y residuals [before]");
    resy_b->GetXaxis()->SetTitle("translation misalignment scale, #mum");
    resy_b->GetYaxis()->SetTitle("y residuals, cm");
    resy_b->SetMarkerStyle(25);
    resy_b->Draw("AP");
    c1.Print(resname_pdf_o); //write canvas and keep the ps file open
    resy_a->SetTitle("y residuals [after]");
    resy_a->GetXaxis()->SetTitle("translation misalignment scale, #mum");
    resy_a->GetYaxis()->SetTitle("y residuals, cm");
    resy_a->SetMarkerStyle(25);
    resy_a->SetMarkerColor(2);
    resy_a->Draw("AP");
    c1.Print(resname_pdf_o); //write canvas and keep the ps file open
    misal_b_0->SetTitle("translation x [before]");
    misal_b_0->GetXaxis()->SetTitle("translation misalignment scale, #mum");
    misal_b_0->GetYaxis()->SetTitle("#Delta_{x}, cm");
    misal_b_0->SetMarkerStyle(25);
    misal_b_0->SetMaximum(misalsc*1.1*1e-4);
    misal_b_0->SetMinimum(0.);
    misal_b_0->Draw("AP");
    c1.Print(resname_pdf_o); //write canvas and keep the ps file open
    misal_a_0->SetTitle("translation x [after]");
    misal_a_0->GetXaxis()->SetTitle("translation misalignment scale, #mum");
    misal_a_0->GetYaxis()->SetTitle("#Delta_{x}, cm");
    misal_a_0->SetMarkerStyle(25);
    misal_a_0->SetMarkerColor(2);
    misal_a_0->SetMaximum(misalsc*1.1*1e-4);
    misal_a_0->SetMinimum(0.);
    misal_a_0->Draw("AP");
    c1.Print(resname_pdf_o); //write canvas and keep the ps file open
    misal_b_1->SetTitle("translation y [before]");
    misal_b_1->GetXaxis()->SetTitle("translation misalignment scale, #mum");
    misal_b_1->GetYaxis()->SetTitle("#Delta_{y}, cm");
    misal_b_1->SetMarkerStyle(25);
    misal_b_1->SetMaximum(misalsc*1.1*1e-4);
    misal_b_1->SetMinimum(0.);
    misal_b_1->Draw("AP");
    c1.Print(resname_pdf_o); //write canvas and keep the ps file open
    misal_a_1->SetTitle("translation y [after]");
    misal_a_1->GetXaxis()->SetTitle("translation misalignment scale, #mum");
    misal_a_1->GetYaxis()->SetTitle("#Delta_{y}, cm");
    misal_a_1->SetMarkerStyle(25);
    misal_a_1->SetMarkerColor(2);
    misal_a_1->SetMaximum(misalsc*1.1*1e-4);
    misal_a_1->SetMinimum(0.);
    misal_a_1->Draw("AP");
    c1.Print(resname_pdf_o); //write canvas and keep the ps file open
    misal_b_2->SetTitle("translation z [before]");
    misal_b_2->GetXaxis()->SetTitle("translation misalignment scale, #mum");
    misal_b_2->GetYaxis()->SetTitle("#Delta_{z}, cm");
    misal_b_2->SetMarkerStyle(25);
    misal_b_2->SetMaximum(misalsc*1.1*1e-4);
    misal_b_2->SetMinimum(0.);
    misal_b_2->Draw("AP");
    c1.Print(resname_pdf_o); //write canvas and keep the ps file open
    misal_a_2->SetTitle("translation z [after]");
    misal_a_2->GetXaxis()->SetTitle("translation misalignment scale, #mum");
    misal_a_2->GetYaxis()->SetTitle("#Delta_{z}, cm");
    misal_a_2->SetMarkerStyle(25);
    misal_a_2->SetMarkerColor(2);
    misal_a_2->SetMaximum(misalsc*1.1*1e-4);
    misal_a_2->SetMinimum(0.);
    misal_a_2->Draw("AP");
    c1.Print(resname_pdf_o); //write canvas and keep the ps file open
    misal_b_3->SetTitle("rotation x [before]");
    misal_b_3->GetXaxis()->SetTitle("translation misalignment scale, #mum");
    misal_b_3->GetYaxis()->SetTitle("#Delta_{#alpha}, rad");
    misal_b_3->SetMarkerStyle(25);
    misal_b_3->SetMaximum(rot_scale*10.1*1e-3);
    misal_b_3->SetMinimum(0.);
    misal_b_3->Draw("AP");
    c1.Print(resname_pdf_o); //write canvas and keep the ps file open
    misal_a_3->SetTitle("rotation x [after]");
    misal_a_3->GetXaxis()->SetTitle("translation misalignment scale, #mum");
    misal_a_3->GetYaxis()->SetTitle("#Delta_{#alpha}, rad");
    misal_a_3->SetMarkerStyle(25);
    misal_a_3->SetMarkerColor(2);
    misal_a_3->SetMaximum(rot_scale*10.1*1e-3);
    misal_a_3->SetMinimum(0.);
    misal_a_3->Draw("AP");
    c1.Print(resname_pdf_o); //write canvas and keep the ps file open
    misal_b_4->SetTitle("rotation y [before]");
    misal_b_4->GetXaxis()->SetTitle("translation misalignment scale, #mum");
    misal_b_4->GetYaxis()->SetTitle("#Delta_{#beta}, rad");
    misal_b_4->SetMarkerStyle(25);
    misal_b_4->SetMaximum(rot_scale*10.1*1e-3);
    misal_b_4->SetMinimum(0.);
    misal_b_4->Draw("AP");
    c1.Print(resname_pdf_o); //write canvas and keep the ps file open
    misal_a_4->SetTitle("rotation y [after]");
    misal_a_4->GetXaxis()->SetTitle("translation misalignment scale, #mum");
    misal_a_4->GetYaxis()->SetTitle("#Delta_{#beta}, rad");
    misal_a_4->SetMarkerStyle(25);
    misal_a_4->SetMarkerColor(2);
    misal_a_4->SetMaximum(rot_scale*10.1*1e-3);
    misal_a_4->SetMinimum(0.);
    misal_a_4->Draw("AP");
    c1.Print(resname_pdf_o); //write canvas and keep the ps file open
    misal_b_5->SetTitle("rotation z [before]");
    misal_b_5->GetXaxis()->SetTitle("translation misalignment scale, #mum");
    misal_b_5->GetYaxis()->SetTitle("#Delta_{#gamma}, rad");
    misal_b_5->SetMarkerStyle(25);
    misal_b_5->SetMaximum(rot_scale*1.1*1e-3);
    misal_b_5->SetMinimum(0.);
    misal_b_5->Draw("AP");
    c1.Print(resname_pdf_o); //write canvas and keep the ps file open
    misal_a_5->SetTitle("rotation z [after]");
    misal_a_5->GetXaxis()->SetTitle("translation misalignment scale, #mum");
    misal_a_5->GetYaxis()->SetTitle("#Delta_{#gamma}, rad");
    misal_a_5->SetMarkerStyle(25);
    misal_a_5->SetMarkerColor(2);
    misal_a_5->SetMaximum(rot_scale*1.1*1e-3);
    misal_a_5->SetMinimum(0.);
    misal_a_5->Draw("AP");
