...
// # for DPM+FairPrimaryGenerator generation with filtering events
// # 22/01/2014
// # author: A.Karavdina
//###################################
void runLumiPixel0SimDPMDirectFilter(const int nEvents=10, const int startEvent=0, const double mom=15, TString storePath="tmpOutputDPM", 
...
// // //-------------------------  CAVE      -----------------
 ...
 //-------------------------  STT       -----------------
  ...
  //add some filter creteria
  //AddFilterMinMax( int min, int max, int pdgCode1, int pdgCode2=0, int pdgCode3=0, int pdgCode4=0, int pdgCode5=0, int pdgCode6=0, int pdgCode7=0, int pdgCode8=0 )
  dpmGen->AddFilterMinMax(1,5,-211);
  dpmGen->SetFilterMaxTries(99999);// number of tries before giving up
  ...
  printf("%f events were simulated in dpm with %f unsuccessful attempts to find an event that suits your filters\n\n",dpmGen->GetNumberOfSimulatedEvents(),dpmGen->GetNumberOfFilterFailedEvents());
