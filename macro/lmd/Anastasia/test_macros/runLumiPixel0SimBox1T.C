...
void runLumiPixel0SimBox1T(const int nEvents=10, const int startEv=0, TString storePath="tmpOutput", const int verboseLevel=0, const int particle=-2212, const double mom=15, const int trkNum=1, const int seed=0)
{
 ...
 // //EvtGen Generator
  ...
  // //  fSolField->SetField(0,0.1,2); // values are in T //for cross-check with results from maps set Bz=2T
  // fSolField->SetField(0,0,10); // values are in kG //for cross-check with results from maps set Bz=1T
