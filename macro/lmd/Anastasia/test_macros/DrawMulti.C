...
void DrawMulti(){
  ...
  //	TFile *f = new TFile("/home/karavdina/soft/pandaroot/macro/lmd/DPM_el_inel_15/Lumi_digi_0.root","READ");
	...
	TH1D *hml = new TH1D("hml","; multiplicity, trks/ev",25,0,25);
       	double nEv =trec->Project("hmlt","LMDPixelDigisQ.GetNIndices():LMDPixelDigisQ.fTimeStamp");
	//	trec->Project("hml","LMDPixelDigis.GetNIndices()","LMDPixelDigis.fTimeStamp<39.","");
	trec->Project("hml","LMDPixelDigisQ.GetNIndices()","LMDPixelDigisQ.fTimeStamp<39.");
	//	nEv *=1e-2; 
