void DrawXYsystem(){
 ...
 TH2D *hxdx0cm = new TH2D("hxdx0cm",";X_{MC},cm;(X_{MC}-X_{REC}), cm",2e1,-1,1,1e3,-100,100);
 ...
 TFile *fin10cm = new TFile("/panda/pandaroot/macro/lmd/Anastasia/tests/RestGas/testRestGas_z_-10cm/mom_1_5/Lumi_TrksQA_0.root","READ");
 TTree *tree10cm = (TTree*)fin10cm->Get("cbmsim");
 TH2D *hxdx10cm = new TH2D("hxdx10cm",";X_{MC},cm;(X_{MC}-X_{REC}), cm",2e1,-1,1,1e3,-100,100);
...
TFile *fin20cm = new TFile("/panda/pandaroot/macro/lmd/Anastasia/tests/RestGas/testRestGas_z_-20cm/mom_1_5/Lumi_TrksQA_0.root","READ");
 TTree *tree20cm = (TTree*)fin20cm->Get("cbmsim");
 TH2D *hxdx20cm = new TH2D("hxdx20cm",";X_{MC},cm;(X_{MC}-X_{REC}), cm",2e1,-1,1,1e3,-100,100);
...
TFile *fin50cm = new TFile("/panda/pandaroot/macro/lmd/Anastasia/tests/RestGas/testRestGas_z_-50cm/mom_1_5/Lumi_TrksQA_0.root","READ");
 TTree *tree50cm = (TTree*)fin50cm->Get("cbmsim");
 TH2D *hxdx50cm = new TH2D("hxdx50cm",";X_{MC},cm;(X_{MC}-X_{REC}), cm",2e1,-1,1,1e2,-100,100);
