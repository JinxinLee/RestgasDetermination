void runLumiPixel5BPtest(const int nEvents=10, const int startEvent=0, TString storePath="tmpOutput", const int verboseLevel=0, const TString Method="Geane", const bool mergedHits=true, const double mom=15)
{
  // ========================================================================
  ...
  if(Method=="Geane"){
    ...
    fRun->AddTask(Geane);
    PndLmdBPtestTask* lmdgeane = new PndLmdBPtestTask(fpBeam, IP);
    ...
    //    }
    //    else{
      cout<<"For Method "<<Method.Data()<<" test task doesn't exist!"<<endl;
      break;
      //    }
  }
