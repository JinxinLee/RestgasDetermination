...
void AssymN_IPpos(TString path = "/panda/myResults/AssymIP/DPM/mom_1_5/"){
 ...
 c1->cd(1);
 hA0->SetTitle("A0");
 hA0->GetZaxis()->SetRangeUser(-90,0);
 //hA0->GetZaxis()->Set(1000,-90,0);
 hA0->Draw("colz");
c1->cd(2);
 hA1->SetTitle("A1");
 hA1->GetZaxis()->SetRangeUser(-90,0);
 hA1->Draw("colz");
c1->cd(3);
 hA2->SetTitle("A2");
 hA2->GetZaxis()->SetRangeUser(-90,0);
 hA2->Draw("colz");
 c1->cd(4);
 hA3->SetTitle("A3");
 hA3->GetZaxis()->SetRangeUser(-90,0);
 hA3->Draw("colz");
c1->cd(5);
 hA4->SetTitle("A4");
 hA4->GetZaxis()->SetRangeUser(-90,0);
 hA4->Draw("colz");
c1->cd(6);
 hA5->SetTitle("A5");
 hA5->GetZaxis()->SetRangeUser(-90,0);
 hA5->Draw("colz");
 c1->cd(7);
 hA6->SetTitle("A6");
 hA6->GetZaxis()->SetRangeUser(-90,0);
 hA6->Draw("colz");
c1->cd(8);
 hA7->SetTitle("A7");
 hA7->GetZaxis()->SetRangeUser(-90,0);
 hA7->Draw("colz");
c1->cd(9);
 hA8->SetTitle("A8");
 hA8->GetZaxis()->SetRangeUser(-90,0);
 hA8->Draw("colz");
c1->cd(10);
 hA9->SetTitle("A9");
 hA9->GetZaxis()->SetRangeUser(-90,0);
 hA9->Draw("colz");
