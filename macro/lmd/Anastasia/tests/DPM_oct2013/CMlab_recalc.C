...
void CMlab_recalc(){
  ...
  // double cosTh1 = -0.95; //1.5 GeV/c
  // double cosTh2 = 0.93;

  double t1 = 0.02; //4.60 GeV/c
  double t2 = 1;

  /// fixed params by channel
  double Plab = 4; //GeV/c bar p mom in LAB frame
  ...
  double cosTh1 = 1-t1*0.5/(Pcm*Pcm);
  ...
  cout<<"In CM costh1 = "<<cosTh1<<endl;
  cout<<"In LAB Th1 = "<<TMath::ATan(tgTh1_lab)<<" [rad]"<<endl;
  cout<<"In LAB Th1 = "<<180.*TMath::ATan(tgTh1_lab)/TMath::Pi()<<endl;
