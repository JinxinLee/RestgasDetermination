{
  ...
  // Input file
  TString inDigiFile = "llbar_digi_evtgen.root";
  TString inSimFile = "llbar_sim_evtgen.root";

  // Parameter file
  TString parFile = "llbar_params_evtgen.root";

  // Output file
  TString outFile = "llbar_reco_evtgen.root";
...
//  mvdTrackFinder->SetPersistence(kFALSE); // warum??
  ...
  sttFindTracks->SetPersistence(kTRUE);
