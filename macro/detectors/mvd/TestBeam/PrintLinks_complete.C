...
//  Int_t nEvents = 0;  // if 0 all the vents will be processed
  ...
  TString digiInputFile = "2014-10-27-00-06-02_50_MHz_Hits.root";
  TString recoInput = "2014-10-27-00-06-02_50_MHz_Hits_Filtered.root";
  ...
  fRun->SetInputFile(digiInputFile);
