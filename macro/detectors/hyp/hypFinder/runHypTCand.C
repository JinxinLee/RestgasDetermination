...
// Verbosity level (0=quiet, 1=event level, 2=track level, 3=debug)
  ...
  Int_t nEvents = 100;//50000;
  TString parFile="../PiTrparams.root";//pidparams.root";//pidparams.root";
 
  TString outFile = "HypPiTr.root";//HypPidIdrecdos2.root";
...
// ------------------------------------------------------------------------
  ...
  // =========================================================================
   ...
   PndHypIdealPRTask* DemoPR = new PndHypIdealPRTask();
