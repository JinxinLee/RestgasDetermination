...
//  Int_t nEvents = 0;  // if 0 all the vents will be processed
  ...
  TString digiInputFile = creator.GetDigiFileName("timebased");
  TString recoInput = creator.GetRecoFileName("timebased");
 // TString pidInput = "pid_complete.root";
 

   TString sysFile = gSystem->Getenv("VMCWORKDIR");
   TString parFile = creator.GetParFileName(); // at the moment you do not need it
