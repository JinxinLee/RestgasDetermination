int full_gg(TString simdatei="sim_gg.root", TString fulldatei="full_gg.root", TString param="simparam.root"){
  ...
  // It loads a simulation file and digitize hits for EMC
	...
	//gSystem::GetPathInfo();
	TString inFile = simdatei;// "TString("Daten/").Append(simdatei)";
	...
	// Parameter file
	TString parFile = param; //"TString("Daten/").Append(param)"; // at the moment you do not need it
  
	// Digitisation file (ascii)
	TString digiFile = "emc.par";
  
	// Output file
	TString outFile = fulldatei; //"TString("Daten/").Append(fulldatei)";
