...
// first step --> Xim + Xib (annihilation) production at 3 GeV/c (pbar)
 ...
 TString infile="../Alicia/PiTrGeo1_recdos.root";//HypId1TXXbP8pmBup_Geo2recdos.root";
 if (outfile=="")  outfile="../Alicia/MicroSimpleG4Bup1TXm_Geo2.root";//MicroSimpleG4Bup1TXXbP8_Geo2.root";
 TString RecoFile = "../Alicia/hypIdealrecoXm_Geo2.root";//hypIdealrecoXXb_Geo2.root";
