...
void run_HypSimpleAna_Geo2(TString base="Hit_hypIdReco",int nevts=0, TString outfile="")
{
  TStopwatch timer;
  timer.Start();
  gDebug=0;
 ...
 gSystem->Load("libRho");
  ...
  //aida second step 0.5 T
   TString simfile = "../Alicia/Bup_hypFSG41TXm.root";//Bup_hypFSG41TXXb_Geo2.root";
       Int_t nEvents = 0;//50000;
       TString parFile="../Alicia/Bup_hypFS1TG4Xmparams.root";//Bup_hypFS1TG4XXb_Geo2params.root";
      TString recofile = "../Alicia/hypIdealrecoXm_Geo2.root";
      TString infile = "../Alicia/MicroSimpleG4Bup1TXm_Geo2.root";//MicroSimpleG4Bup1TXXbP8_Geo2.root";
      if (outfile=="")  outfile="AnaFSimpleBup1TXm_Bg.root";//AnaFSimpleP8Bup1TXXb.root";
