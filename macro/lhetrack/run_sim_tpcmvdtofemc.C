void run_sim_tpcmvdtofemc(Int_t nEvents=1000, Float_t pT=1.0){
  ...
  fRun->SetOutputFile("points_tpcmvdemctof.root");
  ...
  boxGen->SetThetaRange(40., 140.); // Polar angle in lab system range [degree]
