root -l -b -q 'merge.C("ntp1","ntp1_2phi_A.root","data/M2phi_A_EMC*_ana.root","data/DPM2phi_A_EMC*_ana.root")'
root -l -b -q 'merge.C("ntp1","ntp1_2phi_B.root","data/M2phi_B_EMC*_ana.root","data/DPM2phi_B_EMC*_ana.root")'
