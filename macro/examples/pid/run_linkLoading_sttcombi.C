{
  // ========================================================================
	 ...
	 TString parFile = "params_sttcombi.root";
	  ...
	  TString linkFile = "links_sttcombi.root";
...
//  fRun->LoadGeometry();
  ...
  PndMCMatchSelectorTask* mcSelector = new PndMCMatchSelectorTask(31,1); // MC Match for charged particles
  mcSelector->SetAllWeights(1.);
  fRun->AddTask(mcSelector);

  PndMCMatchSelectorTask* mcSelector2 = new PndMCMatchSelectorTask(32,1); // MC Match for neutral particles
