...
int prod_sim_efficiency(TString prefix="", Int_t nEvents = 100, TString inputGen="", Float_t pbeam = 0. )
{
  ...
  //TString opt=""; // for FairFilteredPrimaryGenerator the options must contain this key word
  ...
  //fRun->SetDpmTheta_min(2.7 / 1000. * 180. / 3.1415926);
  //fRun->SetDpmTheta_max(13. / 1000. * 180. / 3.1415926);
  fRun->SetDpmTheta_min(22.);
  fRun->SetDpmTheta_max(150.);
  fRun->SetIP(0, 0, 10);
