...
1. 0. 0. 0. 0. 1. 0. 1. 0.\n"
 ...
 for($i=133; $i<193;$i++){
 $Xpos = $diametrostraw*( $nstraws/2  - ($i - ($nstraws + 1) ));
 print OUT "//*********************                                                           
 fts01tube#$i
 fts01assembly#1
 $Xpos $Ypos $z2
 ...
 for($i=265; $i<325;$i++){
 $Xpos = (1/$cosangle)*$diametrostraw*( $nstraws/2 - 0.5 - ($i - (2*$nstraws + 1)) );
 print OUT "//*********************                                                           
 fts01tube#$i
 fts01assembly#1
 $Xpos $Ypos $Zpos
 ...
 for($i=325; $i<337;$i++){
 $Xpos = (1/$cosangle)*$diametrostraw*( $nstraws/2 - 0.5 - ($i - (2*$nstraws + 1))+($Yshort*$sinangle)/$diametrostraw );
 print OUT "//*********************                                                           
 fts01tubedown#$i
 fts01assembly#1
 $Xpos -$Yshort $Zpos 
 ...
 for($i=397; $i<457;$i++){
 $Xpos = (1/$cosangle)*$diametrostraw*( $nstraws/2 -1- ($i - (3*$nstraws + 1)) );
 print OUT "//*********************                                                           
 fts01tube#$i
 fts01assembly#1
 $Xpos $Ypos $z2
 ...
 for($i=457; $i<469;$i++){
 $Xpos = (1/$cosangle)*$diametrostraw*( $nstraws/2 -1- ($i - (3*$nstraws + 1))+($Yshort*$sinangle)/$diametrostraw  );
 print OUT "//*********************                                                           
 fts01tubedown#$i
 fts01assembly#1
 $Xpos -$Yshort $z2 
 ...
 #$Zpos = 3054-$diametrostraw/2;
  ...
  for($i=529; $i<589;$i++){
  $Xpos =  (1/$cosangle)*$diametrostraw*( $nstraws/2 - 0.5  - ($i - (4*$nstraws + 1)) );
  print OUT "//*********************                                                           
  fts01tube#$i
  fts01assembly#1
  $Xpos $Ypos $Zpos
  ...
  for($i=589; $i<601;$i++){
  $Xpos =  (1/$cosangle)*$diametrostraw*( $nstraws/2 - 0.5 - ($i - (4*$nstraws + 1))-($Yshort*$sinangle)/$diametrostraw );
  print OUT "//*********************                                                           
  fts01tubedown#$i
  fts01assembly#1
  $Xpos -$Yshort $Zpos 
  ...
  for($i=661; $i<721;$i++){
  $Xpos =  (1/$cosangle)*$diametrostraw*( $nstraws/2 -1- ($i - (5*$nstraws + 1)) );
  print OUT "//*********************                                                           
  fts01tube#$i
  fts01assembly#1
  $Xpos $Ypos $z2
  ...
  for($i=721; $i<733;$i++){
  $Xpos =  (1/$cosangle)*$diametrostraw*( $nstraws/2 -1- ($i - (5*$nstraws + 1))-($Yshort*$sinangle)/$diametrostraw );
  print OUT "//*********************                                                           
  fts01tubedown#$i
  fts01assembly#1
  $Xpos -$Yshort $z2 
  ...
  for($i=793; $i<853;$i++){
  $Xpos = $diametrostraw*( $nstraws/2 - 0.5 - ($i - (6*$nstraws + 1)) );
  print OUT "//*********************                                                           
  fts01tube#$i
  fts01assembly#1
  $Xpos $Ypos $Zpos
  ...
  for($i=925; $i<985;$i++){
  $Xpos = $diametrostraw*( $nstraws/2 - ($i - (7*$nstraws + 1)) );
  print OUT "//*********************                                                           
  fts01tube#$i
  fts01assembly#1
  $Xpos $Ypos $z2
...
1. 0. 0. 0. 0. 1. 0. 1. 0.\n"
 ...
 ";
 for($i=2; $i<81;$i++){
 $Xpos = (1/$cosangle)*$diametrostraw*( $nstraws/2 + 0.5 - $i);
 print OUT "//*********************
 fts32tube#$i
 fts03assembly#1
 $Xpos $Ypos $Zpos
 ...
 $Yshort = $shortHalf+($hhole/2);
 $Xpos = (1/$cosangle)*$diametrostraw*( $nstraws/2 + 0.5 - $i + ($Yshort*$sinangle)/$diametrostraw);
 $raggio = $diametrostraw/2.;
 print OUT "//*********************
 fts32tubedown#$i
 fts03assembly#1
 ...
 ";
 for($i=82; $i<97;$i++){
 $Xpos = (1/$cosangle)*$diametrostraw*( $nstraws/2 + 0.5 - $i +  ($Yshort*$sinangle)/$diametrostraw); #1.7
 print OUT "//*********************
 fts32tubedown#$i
 fts03assembly#1
 $Xpos -$Yshort $Zpos
 ...
 $z2 = $Zpos + 0.5*sqrt(3.)*$diametrostraw;
 for($i=177; $i<257;$i++){
 $Xpos = (1/$cosangle)*$diametrostraw*( $nstraws/2  - ($i - ($nstraws+1)) );
 print OUT "//*********************                                                  
 fts32tube#$i
 fts03assembly#1  
 $Xpos $Ypos $z2
 ...
 #### tubi sotto la beam pipe
 for($i=257; $i<273;$i++){
 $Xpos = (1/$cosangle)*$diametrostraw*( $nstraws/2 - ($i - ($nstraws+1)) + ($Yshort*$sinangle)/$diametrostraw );
 print OUT "//*********************
 fts32tubedown#$i
 fts03assembly#1
 $Xpos -$Yshort $z2
...
";
for($i=82; $i<97;$i++){
$Xpos = (1/$cosangle)*$diametrostraw*( $nstraws/2 + 0.5 - $i + ($Yshort*$sinangle)/$diametrostraw); #1.75
print OUT "//*********************
fts33tubeup#$i
fts03assembly#1
$Xpos $Yshort $Zpos
...
for($i=953; $i<977;$i++){
$Xpos = (1/$cosangle)*$diametrostraw*( $nstraws/2 + 0.5 - ($i - (2*$nstraws+2))+($Yshort*$sinangle)/$diametrostraw); #2.75
print OUT "//*********************                                                           
fts05tubedown#$i
fts05assembly#1
$Xpos -$Yshort $Zpos 
...
for($i=1165; $i<1341;$i++){
$Xpos = (1/$cosangle)*$diametrostraw*( $nstraws/2 - ($i - (3*$nstraws+1)) );
print OUT "//*********************                                                           
fts05tube#$i
fts05assembly#1
$Xpos $Ypos $z2
...
for($i=1341; $i<1365;$i++){
$Xpos = (1/$cosangle)*$diametrostraw*( $nstraws/2 - ($i - (3*$nstraws+1))+($Yshort*$sinangle)/$diametrostraw );
print OUT "//*********************                                                           
fts05tubedown#$i
fts05assembly#1
$Xpos -$Yshort $z2 
...
$raggio = $diametrostraw/2.;
for($i=1941; $i<2117;$i++){
$Xpos = (1/$cosangle)*$diametrostraw*( $nstraws/2 - ($i - (5*$nstraws+1)) );
print OUT "//*********************                                                           
fts05tube#$i
fts05assembly#1
$Xpos $Ypos $z2
...
for($i=2117; $i<2141;$i++){
$Xpos = (1/$cosangle)*$diametrostraw*( $nstraws/2 - ($i - (5*$nstraws+1))-($Yshort*$sinangle)/$diametrostraw );
print OUT "//*********************                                                           
fts05tubedown#$i
fts05assembly#1
$Xpos -$Yshort $z2 
...
for($i=953; $i<977;$i++){
$Xpos = (1/$cosangle)*$diametrostraw*( $nstraws/2 + 0.5 - ($i - (2*$nstraws+1))+($Yshort*$sinangle)/$diametrostraw); #3.35
print OUT "//*********************                                                           
fts06tubedown#$i
fts06assembly#1
$Xpos -$Yshort $Zpos 
...
$raggio = $diametrostraw/2.;
for($i=2329; $i<2505;$i++){
$Xpos = $diametrostraw*( $nstraws/2 - ($i - (6*$nstraws+1)) );
print OUT "//*********************                                                           
fts06tube#$i
fts06assembly#1
$Xpos $Ypos $Zpos
...
$raggio = $diametrostraw/2.;
for($i=2717; $i<2893;$i++){
$Xpos = $diametrostraw*( $nstraws/2 +0.5 - ($i - (7*$nstraws+1)) );
print OUT "//*********************                                                           
fts06tube#$i
fts06assembly#1
$Xpos $Ypos $z2
