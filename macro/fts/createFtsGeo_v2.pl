...
# tungsteno
###################
# number of straws n the first layer: 128 straws
$nstraws=128;
...
";
for($i=2; $i<91;$i++){
$Xpos = (1/$cosangle)*$diametrostraw*( 192/2 + 0.5 - $i);
print OUT "//*********************
fts32tube#$i
fts03assembly#1
$Xpos $Ypos $Zpos
...
###layer32
$Xpos = (1/$cosangle)*$diametrostraw*( 192/2 + 0.5 - $i + (217.35*$sinangle)/$diametrostraw);
...
";
for($i=92; $i<103;$i++){
$Xpos = (1/$cosangle)*$diametrostraw*( 192/2 + 0.5 - $i +  (217.35*$sinangle)/$diametrostraw); #1.7
print OUT "//*********************
fts32tubedown#$i
fts03assembly#1
$Xpos -217.35 $Zpos
...
$z2 = $Zpos + 0.5*sqrt(3.)*$diametrostraw;
for($i=193; $i<283;$i++){
$Xpos = (1/$cosangle)*$diametrostraw*( 192/2  - ($i - 193) );
print OUT "//*********************                                                  
fts32tube#$i
fts03assembly#1  
$Xpos $Ypos $z2
...
#### tubi sotto la beam pipe
for($i=283; $i<295;$i++){
$Xpos = (1/$cosangle)*$diametrostraw*( 192/2 - ($i - 193) + (217.35*$sinangle)/$diametrostraw );
print OUT "//*********************
fts32tubedown#$i
fts03assembly#1
$Xpos -217.35 $z2
...
";
for($i=92; $i<103;$i++){
$Xpos = (1/$cosangle)*$diametrostraw*( 192/2 + 0.5 - $i + (223.7*$sinangle)/$diametrostraw); #1.75
print OUT "//*********************
fts33tubeup#$i
fts03assembly#1
$Xpos 223.7 $Zpos
...
#### tubi sotto la beam pipe
for($i=283; $i<295;$i++){
$Xpos = (1/$cosangle)*$diametrostraw*( 192/2 - ($i - 193) - (223.7*$sinangle)/$diametrostraw );
print OUT "//*********************
fts33tubedown#$i
fts03assembly#1
$Xpos -223.7 $z2
...
############short tube#########for the beam pipe hole#########bassi
############short tube#########for the beam pipe hole#########
$Xpos = (1/$cosangle)*$diametrostraw*( 192/2 + 0.5 - $i + (236.6*$sinangle)/$diametrostraw); #1.85
...
#### tubi sotto la beam pipe
for($i=283; $i<295;$i++){
$Xpos = (1/$cosangle)*$diametrostraw*( 192/2 - ($i - 193) + (236.6*$sinangle)/$diametrostraw );
print OUT "//*********************
fts36tubedown#$i
fts03assembly#1
$Xpos -236.6 $z2
...
#### tubi sotto la beam pipe
for($i=283; $i<295;$i++){
$Xpos = (1/$cosangle)*$diametrostraw*( 192/2 - ($i - 193) - (242.95*$sinangle)/$diametrostraw );
print OUT "//*********************
fts37tubedown#$i
fts03assembly#1
$Xpos -242.95 $z2
...
1. 0. 0. 0. 0. 1. 0. 1. 0.\n"
 ...
 $z2 = $Zpos + 0.5*sqrt(3.)*$diametrostraw;
 for($i=401; $i<587;$i++){
 $Xpos = $diametrostraw*( $nstraws/2  - ($i - 401) );
 print OUT "//*********************                                                           
 fts05tube#$i
 fts05assembly#1
 $Xpos $Ypos $z2
...
########secondo double layers: inclinazione dei tubi di +5 gradi######### 
 ...
 for($i=801; $i<987;$i++){
 $Xpos = (1/$cosangle)*$diametrostraw*( $nstraws/2 + 0.5 - ($i - 801) );
 print OUT "//*********************                                                           
 fts05tube#$i
 fts05assembly#1
 $Xpos $Ypos $Zpos
 ...
 for($i=987; $i<1006;$i++){
 $Xpos = (1/$cosangle)*$diametrostraw*( $nstraws/2 + 0.5 - ($i - 801)+(354.5*$sinangle)/$diametrostraw); #2.75
 print OUT "//*********************                                                           
 fts05tubedown#$i
 fts05assembly#1
 $Xpos -354.5 $Zpos 
 ...
 for($i=987; $i<1006;$i++){
 $Xpos = (1/$cosangle)*$diametrostraw*( $nstraws/2 + 0.5 - ($i - 801)-(354.5*$sinangle)/$diametrostraw );
 print OUT "//*********************                                                           
 fts05tubeup#$i
 fts05assembly#1
 $Xpos 354.5 $Zpos 
...
#####secondo strato########
 ...
 for($i=1201; $i<1387;$i++){
 $Xpos = (1/$cosangle)*$diametrostraw*( $nstraws/2 - ($i - 1201) );
 print OUT "//*********************                                                           
 fts05tube#$i
 fts05assembly#1
 $Xpos $Ypos $z2
 ...
 for($i=1387; $i<1406;$i++){
 $Xpos = (1/$cosangle)*$diametrostraw*( $nstraws/2 - ($i - 1201)+(354.5*$sinangle)/$diametrostraw );
 print OUT "//*********************                                                           
 fts05tubedown#$i
 fts05assembly#1
 $Xpos -354.5 $z2 
...
########terzo double layers: inclinazione dei tubi di -5 gradi#########
 ...
 for($i=1601; $i<1787;$i++){
 $Xpos = (1/$cosangle)*$diametrostraw*( $nstraws/2 + 0.5  - ($i - 1601) );
 print OUT "//*********************                                                           
 fts05tube#$i
 fts05assembly#1
 $Xpos $Ypos $Zpos
 ...
 for($i=1787; $i<1806;$i++){
 $Xpos = (1/$cosangle)*$diametrostraw*( $nstraws/2 + 0.5 - ($i - 1601)-(354.5*$sinangle)/$diametrostraw );
 print OUT "//*********************                                                           
 fts05tubedown#$i
 fts05assembly#1
 $Xpos -354.5 $Zpos 
 ...
 $raggio = $diametrostraw/2.;
 for($i=2001; $i<2187;$i++){
 $Xpos = (1/$cosangle)*$diametrostraw*( $nstraws/2 - ($i - 2001) );
 print OUT "//*********************                                                           
 fts05tube#$i
 fts05assembly#1
 $Xpos $Ypos $z2
 ...
 for($i=2187; $i<2206;$i++){
 $Xpos = (1/$cosangle)*$diametrostraw*( $nstraws/2 - ($i - 2001)-(354.5*$sinangle)/$diametrostraw );
 print OUT "//*********************                                                           
 fts05tubedown#$i
 fts05assembly#1
 $Xpos -354.5 $z2 
 ...
 $raggio = $diametrostraw/2.;
 for($i=2401; $i<2587;$i++){
 $Xpos = $diametrostraw*( $nstraws/2 - 0.5 - ($i - 2401) );
 print OUT "//*********************                                                           
 fts05tube#$i
 fts05assembly#1
 $Xpos $Ypos $Zpos
 ...
 $raggio = $diametrostraw/2.;
 for($i=2801; $i<2987;$i++){
 $Xpos = $diametrostraw*( $nstraws/2 - ($i - 2801) );
 print OUT "//*********************                                                           
 fts05tube#$i
 fts05assembly#1
 $Xpos $Ypos $z2
...
########quarto double layers: inclinazione dei tubi di 0 gradi#########
  ...
  $raggio = $diametrostraw/2.;
  for($i=2401; $i<2585;$i++){
  $Xpos = $diametrostraw*( $nstraws/2 - ($i - 2401) );
  print OUT "//*********************                                      
  fts06tube#$i
  fts06assembly#1
  $Xpos $Ypos $Zpos
  ...
  $raggio = $diametrostraw/2.;
  for($i=2801; $i<2985;$i++){
  $Xpos = $diametrostraw*( $nstraws/2 +0.5- ($i - 2801) );
  print OUT "//*********************
  fts06tube#$i
  fts06assembly#1
  $Xpos $Ypos $z2
