...
int hypGeGeoBuilderDEGASBall40_6sym_offset20(Double_t ZShift = 0)
{
  ...
  gSystem->Load("libHypGe");
	...
	TString outfile= "../../../../geometry/hypGeGeoBall40_6sym_Offset15.root";
...
//cout<<" geom "<<geom<<endl;           
  geom->SetTopVolume(top);
	...
	const Int_t NumberOfCluster=18;
	Double_t CoordinatesAndAngles[NumberOfCluster*6];
	string Filename = "DEGASBall40_6Sym_Offset20CoordinatesAndAngles.txt";
