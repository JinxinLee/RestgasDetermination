...
void hypGeGeoBuilderTripleBall40Offset20Geometry_STTFittingCrystalsOnly()
{
  ...
  gSystem->Load("libHypGe");
	...
	TString outfile= "../../../../geometry/hypGeGeoTripleCluster_Ball40_Offset20_STTFittingCrystalsOnly.root";
...
//cout<<" geom "<<geom<<endl;           
  geom->SetTopVolume(top);
	...
	string Filename = "TripleBall40GeometrySTTFittingCoordinatesAndAngles.txt";
	...
	//c1->x3d();
	geom->CheckOverlaps(0.0000000001,option="d"); 
	geom->PrintOverlaps();
