...
void hypGeGeoBuilderTripleBall40Offset10Geometry_STTFitting()
{
  ...
  gSystem->Load("libHypGe");
	...
	TString outfile= "../../../../geometry/hypGeGeoTripleCluster_Ball40_Offset10_STTFitting.root";
...
//cout<<" geom "<<geom<<endl;           
  geom->SetTopVolume(top);
	...
	Double_t SourceToBallCenterOffset = 10;	
