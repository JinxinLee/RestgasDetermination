void tb_digi_scit_vB()
{
  ...
  TString inFile = "sim_scit_vB.root";
  TString parFile = "sim_scit_params_vB.root"; // at the moment you do not need it
  TString digiFile = "all.par";
  TString outFile = "tb_digi_scit_vB.root";
