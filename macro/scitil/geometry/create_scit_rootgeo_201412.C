void create_scit_rootgeo_201412(Double_t distance = 750){
 ...
 //--------------------------------------------------------------------
  ...
  TString outfile= "../../../geometry/SciTil_201412.root";
  ...
  //Double_t bx[22],by[22],bz[22];   // why here are char arrays declareted
  //Double_t bvx[46],bvy[46],bvz[46];

//char name[13];   // why here are char arrays declareted
//char namB[13];
//char namV[13];
//char name1[13];
//char namB1[13];
