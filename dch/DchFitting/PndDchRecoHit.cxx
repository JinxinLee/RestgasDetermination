...
//
// Description:
//      Implementation of class PndDchRecoHit
//      see PndDchRecoHit.h for details
//
// Environment:
			      ...
			      const TMatrixT<double>& state)
{
  ...
  double trackr=trackpos[0][0];
  double res1=_hitCoord[0][0]+_wirepos-trackpos[0][0];
  double res2=-_hitCoord[0][0]+_wirepos-trackpos[0][0];
