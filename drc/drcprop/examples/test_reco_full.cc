...
int main(int argc, char *argv[])
{
  ...
  int limit_two_reflections = 14;

  lut_x[15] = (TH2D*)hfile->Get("kbarx_side235");
  lut_y[15] = (TH2D*)hfile->Get("kbary_side235");
  lut_z[15] = (TH2D*)hfile->Get("kbarz_side235");
  lut_x[16] = (TH2D*)hfile->Get("kbarx_side253");
  lut_y[16] = (TH2D*)hfile->Get("kbary_side253");
  lut_z[16] = (TH2D*)hfile->Get("kbarz_side253");
  ...
  int limit_three_reflections = 26;
