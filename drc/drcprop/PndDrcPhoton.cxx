...
//----------------------------------------------------------------------
bool PndDrcPhoton::Refract(XYZVector normal, double n1, double ex1, double n2, double ex2) 
{   
//     fVerbosity =4;
//     cout << "******************** REFRACT ******************" << endl;
...
//     bool fresnel_reflect = Fresnel(normal, n1, ex1, n2, ex2);
//     double diffuse = 0.5; // diffused contribution (50 %)
