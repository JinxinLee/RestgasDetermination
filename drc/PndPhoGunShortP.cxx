...
//   Rout1     =  fR + fHThick + fGeo->EVoffset()+ fGeo->boxGap() + fGeo->boxThick() + 30.*tan(30.*fpi/180.); 
   Rout1     =  fR - fHThick - fEVdrop -fGeo->boxGap() -fGeo->boxThick() + 5.*(fGeo->McpActiveArea() + fGeo->McpSize() - fGeo->McpActiveArea() + fGeo->McpGap()) -(fGeo->McpSize() - fGeo->McpActiveArea() + fGeo->McpGap()); 
...
//   fTree->Branch("LUT",&fLut,256000,0); 
  for(Int_t iLut=0; iLut<5; iLut++){
   ...
   cout << "-I- PndPhoGunShortP: Intialization successfull" << endl;
   return kSUCCESS; 
}

// -----   Execution of Task   ---------------------------------------------
void PndPhoGunShortP::Exec(Option_t* option)
{
  nevents++;
...
//    cout<<"boxname - "<<fBarPoint->GetBoxId()<<endl;
    ...
    if(TMath::Nint(fabs(PdPhi-fPhiRot)*180./fpi/fDphi)>0)continue;
    ...
    if(((PndDrcEVPoint*)fEVPointArray->At(EVEntry-1))->GetZ() < fZin-fEVlen+0.01){EVEntry = EVEntry - 1;}
...
//      ReflName.Prepend(Form("%d",PhiSec));
    ...
    if(ReflName == "B1"){fNoB +=1; SelectionName=1;ambiguity =2;}
    if(ReflName == "L1"){fNoL +=1; SelectionName=1;ambiguity =3;}
    if(ReflName == "R1"){fNoR +=1; SelectionName=1;ambiguity =4;}
    if(ReflName == "U1"){fNoU +=1; SelectionName=1;ambiguity =5;}
    if(ReflName == "BU2"){fNoBU +=1; SelectionName=1;ambiguity =6;}
    if(ReflName == "BL2"){fNoBL +=1; SelectionName=1;ambiguity =7;}
    if(ReflName == "BR2"){fNoBR +=1; SelectionName=1;ambiguity =8;}
    if(ReflName == "UL2"){fNoUL +=1; SelectionName=1;ambiguity =9;}
    if(ReflName == "LU2"){fNoLU +=1; SelectionName=1;ambiguity =10;}
    if(ReflName == "UR2"){fNoUR +=1; SelectionName=1;ambiguity =11;}
    if(ReflName == "RU2"){fNoRU +=1; SelectionName=1;ambiguity =12;}
    if(ReflName == "LR2"){fNoLR +=1; SelectionName=1;ambiguity =13;}
    if(ReflName == "LB2"){fNoLB +=1; SelectionName=1;ambiguity =14;}
    if(ReflName == "RB2"){fNoRB +=1; SelectionName=1;ambiguity =15;}
    if(ReflName == "RL2"){fNoRL +=1; SelectionName=1;ambiguity =16;}
    if(ReflName == "BLR3"){fNoBLR +=1; SelectionName=1;ambiguity =17;}
    if(ReflName == "BUR3"){fNoBUR +=1; SelectionName=1;ambiguity =18;}
    if(ReflName == "BUL3"){fNoBUL +=1; SelectionName=1;ambiguity =19;}
    if(ReflName == "BLU3"){fNoBLU +=1; SelectionName=1;ambiguity =20;}
    if(ReflName == "BRL3"){fNoBRL +=1; SelectionName=1;ambiguity =21;}
    if(ReflName == "BRU3"){fNoBRU +=1; SelectionName=1;ambiguity =22;}
    if(ReflName == "URL3"){fNoURL +=1; SelectionName=1;ambiguity =23;}
    if(ReflName == "ULR3"){fNoULR +=1; SelectionName=1;ambiguity =24;}
    if(ReflName == "RBL3"){fNoRBL +=1; SelectionName=1;ambiguity =25;}
//    if(ReflName == "RBU3"){fNoRBU +=1; SelectionName=1;ambiguity =30;}
    if(ReflName == "RLU3"){fNoRLU +=1; SelectionName=1;ambiguity =26;}
//    if(ReflName == "RLB3"){fNoRLB +=1; SelectionName=1;ambiguity =32;}
    if(ReflName == "RUL3"){fNoRUL +=1; SelectionName=1;ambiguity =27;}
//    if(ReflName == "LRB3"){fNoLRB +=1;  SelectionName=1;ambiguity =34;}
    if(ReflName == "LRU3"){fNoLRU +=1; SelectionName=1;ambiguity =28;}
    if(ReflName == "LBR3"){fNoLBR +=1; SelectionName=1;ambiguity =29;}
    if(ReflName == "LBU3"){fNoLBU +=1; SelectionName=1;ambiguity =30;}
    if(ReflName == "LUR3"){fNoLUR +=1; SelectionName=1;ambiguity =31;}
//    if(ReflName == "LUB3"){fNoLUB +=1; SelectionName=1;ambiguity =39;}
    if(ReflName == "URB3"){fNoURB +=1; SelectionName=1;ambiguity =32;}
    if(ReflName == "ULB3"){fNoULB +=1; SelectionName=1;ambiguity =33;}
//    if(ReflName == "UBR3"){fNoUBR +=1;  SelectionName=1;ambiguity =42;}
//    if(ReflName == "UBL3"){fNoUBL +=1; SelectionName=1;ambiguity =43;}
    if(ReflName == "BULR4"){fNoBULR +=1; SelectionName=1;ambiguity =34;}
    if(ReflName == "BURL4"){fNoBURL +=1; SelectionName=1;ambiguity =35;}
    if(ReflName == "BLUR4"){fNoBLUR +=1; SelectionName=1;ambiguity =36;}
    if(ReflName == "BRUL4"){fNoBRUL +=1; SelectionName=1;ambiguity =37;}
    if(ReflName == "LBRU4"){fNoLBRU +=1; SelectionName=1;ambiguity =38;}
    if(ReflName == "LBUR4"){fNoLBUR +=1; SelectionName=1;ambiguity =39;}
    if(ReflName == "RBUL4"){fNoRBUL +=1; SelectionName=1;ambiguity =40;}
    if(ReflName == "BLRU4"){fNoBLRU +=1; SelectionName=1;ambiguity =41;}
    if(ReflName == "BRLU4"){fNoBRLU +=1; SelectionName=1;ambiguity =42;}
    if(ReflName == "BURBL5"){fNoBURBL +=1; SelectionName=1;ambiguity =43;}
    if(ReflName == "BRULB5"){fNoBRULB +=1; SelectionName=1;ambiguity =44;}
    if(ReflName == "BULBR5"){fNoBULBR +=1; SelectionName=1;ambiguity =45;}
    if(ReflName == "BURLB5"){fNoBURLB +=1; SelectionName=1;ambiguity =46;}
    if(ReflName == "BLURB5"){fNoBLURB +=1; SelectionName=1;ambiguity =47;}
    if(ReflName == "BULRB5"){fNoBULRB +=1; SelectionName=1;ambiguity =48;}
...
//cout<<Rin1<<" "<<Rin2<<" "<<Rout1<<" "<<Rout1/cos((Ang_pipe/16.)*fpi/180.)<<endl;
	...
	determint1 = matrix1.Determinant();
      ...
      if(determint1 > -0.1 && determint1 < 0.1)ReflectionType="B";
	fmatrixdata.Reset(0);
	...
	determint2 = matrix1.Determinant();
      if(determint2 > -0.1 && determint2 < 0.1)ReflectionType="U";
	...
	if(ReflectionType!="U" && ReflectionType!="B" && determint3 > determint4)ReflectionType="R";
	if(ReflectionType!="U" && ReflectionType!="B" && determint3 < determint4)ReflectionType="L";
