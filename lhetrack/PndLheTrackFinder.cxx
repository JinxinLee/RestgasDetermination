...
ClassImp(PndLheTrackFinder)

//________________________________________________________________
PndLheTrackFinder::PndLheTrackFinder() {
  //---
...
PndLheTrackFinder::
PndLheTrackFinder( const char *name, const char *title):FairTask(name) {
  //---
...
//________________________________________________________________
InitStatus PndLheTrackFinder::Init() {
  // ---
...
//_________________________________________________________________
void PndLheTrackFinder::Exec(Option_t * option) {
...
//________________________________________________________________
void PndLheTrackFinder::AddTrackForFit(PndLheCMCandidate *track_in) {
  ...
  if (fVerbose) cout << "PndLheTrackFinder::AddTrackForFit "<<  rhits << endl;
  Int_t NHits = 0;
  if (rhits){ 
    ...
    for (Int_t lh = 0; lh < NHits; lh++) {
      ...
      if (NULL==hit) break; 
      track->AddHit(hit);
      if ( (hit->GetDetectorID() == FairRootManager::Instance()->GetBranchId("PndTpcPoint"))     ||
	   (hit->GetDetectorID() == FairRootManager::Instance()->GetBranchId("PndTpcCluster"))     )   tpcHits++;
      if ( (hit->GetDetectorID() == FairRootManager::Instance()->GetBranchId("STTPoint"))     ||
	   (hit->GetDetectorID() == FairRootManager::Instance()->GetBranchId("STTHit"))         )   tpcHits++; // for the moment
      if ( (hit->GetDetectorID() == FairRootManager::Instance()->GetBranchId("MVDPoint"))     ||
	   (hit->GetDetectorID() == FairRootManager::Instance()->GetBranchId("MVDHitsStrip")) ||
	   (hit->GetDetectorID() == FairRootManager::Instance()->GetBranchId("MVDHitsPixel"))   )   mvdHits++;
      if ( (hit->GetDetectorID() == FairRootManager::Instance()->GetBranchId("GemPoint"))     ||
	   (hit->GetDetectorID() == FairRootManager::Instance()->GetBranchId("GemHit"))         )   gemHits++;
    }
    track->SortHits();
...
//________________________________________________________________
void PndLheTrackFinder::DoTracking() {
  //--- Tracking
...
//________________________________________________________________
void PndLheTrackFinder::CheckClones() {
  //---
...
//________________________________________________________________
Bool_t PndLheTrackFinder::TrackExtension(PndLheCMCandidate *track) {
...
//________________________________________________________________
void PndLheTrackFinder::LoopOverHits() {
  //--- loops over all hits
...
void PndLheTrackFinder::CreateTrack(PndLheCMPoint *seed_hit) {
  //---
...
void PndLheTrackFinder::GetThetaRange(TArrayI* list,PndLheCMCandidate *cmtrack) {
  //---  
...
//______________________________________________________________________
void PndLheTrackFinder::GetPhiRange(TArrayI* cl1, PndLheCMCandidate *cmtrack ) {
  //---  
...
//______________________________________________________________________
void PndLheTrackFinder::CopyClones(TClonesArray* cl1,
				   TClonesArray* cl2) {
  //---
