#ifndef _PNDMVDCHARGEWEIGHTINGALGORITHMS_H
#define _PNDMVDCHARGEWEIGHTINGALGORITHMS_H
	...
	~PndMvdChargeWeightingAlgorithms();
	 ...
	 @fn double center_of_gravity(const StripCluster& Cluster)
       ...
       @example
  	   ...
  	   @endcode
       */
	double center_of_gravity(const PndMvdCluster& Cluster);
	 ...
	 @fn double head_tail(const StripCluster& Cluster)
       ...
       @example
  	   ...
  	   @endcode
       */
	double head_tail(const PndMvdCluster& Cluster);
	 ...
	 @fn double eta(const StripCluster& Cluster)
       ...
       @example
  	   ...
  	   @endcode
       */
	double eta(const PndMvdCluster& Cluster);
	         /**
	 @fn double binary(const StripCluster& Cluster)
       ...
       @example
  	   ...
  	   @endcode
       */
	double binary(const PndMvdCluster& Cluster);
	/**
	 ...
	 use the algorithm, which seems to bring the best result with this cluster.
       ...
       @example
  	   ...
  	   @endcode
       */
	double auto_select(const PndMvdCluster& Cluster);
	 ...
	 @fn void MakedNdEta(const StripCluster& Cluster, RunInfo info)
       ...
       @example
  	   ...
  	   @endcode
       */
//	void MakedNdEta(const std::vector<PndMvdCluster>& Cluster, RunInfo& info);
/**@}*/

	void SetCalcStrip(PndMvdCalcStrip* calc){fCalcStrip = calc;};
