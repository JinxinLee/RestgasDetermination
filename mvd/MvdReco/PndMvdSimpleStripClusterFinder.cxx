...
PndMvdSimpleStripClusterFinder::PndMvdSimpleStripClusterFinder(): PndMvdStripClusterBuilder()
{
  // dummy
	fRadius = 1;
}
PndMvdSimpleStripClusterFinder::PndMvdSimpleStripClusterFinder(Int_t rad): PndMvdStripClusterBuilder()
{
	fRadius = rad;
}

PndMvdSimpleStripClusterFinder::~PndMvdSimpleStripClusterFinder()
{
}
...
//           std::cout<<" --- "<<std::endl;
        ...
        {
          std::cout<<"-w- PndMvdSimpleStripClusterFinder::SearchClusters(): cluster hangover? "<<onecluster.size()<<std::endl;
          AddCluster(onecluster,itSide->first);
          onecluster.clear();
        }
...
ClassImp(PndMvdSimpleStripClusterFinder);
...
// double PndMvdSimpleStripClusterFinder::meanColumn(std::vector<PndMvdDigiPixel*>& list){
//   double mean = 0.;
//   if (list.size() == 0){
...
//
//
// double PndMvdSimpleStripClusterFinder::errMeanColumn(std::vector<PndMvdDigiPixel*>& list, double pitch){
//
