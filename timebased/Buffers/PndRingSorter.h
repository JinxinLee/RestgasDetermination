...
#ifndef PndRingSorter_H_
#define PndRingSorter_H_
...
class PndRingSorter : public TObject{
public:
	PndRingSorter(int size = 100, double width = 10):fLowerBoundPointer(0,0), fCellWidth(width), fVerbose(0)
	{
...
private:
	...
	ClassDef(PndRingSorter,1)

};

#endif /* PndRingSorter_H_ */
