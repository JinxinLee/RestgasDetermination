...
PndFsmResponse* 
PndFsmDetTemplate::respond(PndFsmTrack *t)
{
...
bool 
PndFsmDetTemplate::detected(PndFsmTrack *t) const
{
...
double 
PndFsmDetTemplate::dp(PndFsmTrack *t) const
{
...
double
PndFsmDetTemplate::dphi(PndFsmTrack *t) const
{
  return _phiRes; 
}

double
PndFsmDetTemplate::dtheta(PndFsmTrack *t) const
{
  return _thtRes; 
}

void
PndFsmDetTemplate::print(ostream &o)
{
...
void 
PndFsmDetTemplate::initParameters()
{
  _detName         = "PndFsmDetTemplate";
  _thtMin          = 7.765;
  _thtMax          = 159.44;
  _ptmin           = 0.1;
  _pRes            = 0.02;   // 2%
...
bool
PndFsmDetTemplate::setParameter(std::string &name, double value)
{
  // *****************
