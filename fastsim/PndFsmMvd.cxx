...
PndFsmResponse* 
PndFsmMvd::respond(PndFsmTrack *t)
{
...
double
PndFsmMvd::gauss(double x, double x0, double s)
{
...
double 
PndFsmMvd::compdEdx(double p, double M)
{
  double dEdX;
...
bool 
PndFsmMvd::detected(PndFsmTrack *t) const
{
  if (t->hitMapValid()) {
...
double
PndFsmMvd::dphi(PndFsmTrack *) const // t //[R.K.03/2017] unused variable(s)
{
...
double
PndFsmMvd::dtheta(PndFsmTrack *) const // t //[R.K.03/2017] unused variable(s)
{
...
bool
PndFsmMvd::setParameter(std::string &name, double value)
{
  // *****************
