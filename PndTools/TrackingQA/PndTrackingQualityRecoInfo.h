...
class PndTrackingQualityRecoInfo : public TObject
{
 ...
 public:    
  ...
  Int_t GetNofFakeHits() { return fNofMvdPixelFakeHits + fNofMvdStripFakeHits + fNofSttFakeHits + fNofGemFakeHits; } // + fNofSttParalFakeHits + fNofSttSkewFakeHits + fNofSciTilFakeHits; }
