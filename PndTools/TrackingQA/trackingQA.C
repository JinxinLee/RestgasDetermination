void trackingQA(Int_t nEvents = 0)
{
  ...
  fRun->SetInputFile("isoTracker_complete_1000.root");
  ...
  PndTrackingQualityTask* trackingQA = new PndTrackingQualityTask("TracksIsochrone");
