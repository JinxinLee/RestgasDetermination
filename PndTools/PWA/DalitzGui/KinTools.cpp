...
{  
	const int ncol = 99;
	static Int_t col0[ncol], col1[ncol], col2[ncol];
	static Bool_t initialized = kFALSE;

	if (!initialized)
	{	
		{
			Double_t blu[] = {1,0.2,0};
			Double_t red[] = {1,0.2,0};
			Double_t grn[] = {1,0.2,0};
			Double_t stp[] = {0,0.5,1};
			
			Int_t FI = TColor::CreateGradientColorTable(3,stp,red,grn,blu,ncol);
			for (int i=0; i<ncol; i++) col0[i] = FI+i;
		}
		{
			Double_t blu[] = {1,1,1,0,0,0};
			Double_t red[] = {1,0,0,0,1,1};
			Double_t grn[] = {1,0,1,1,1,0};
			Double_t stp[] = {0.0,0.12,0.34,0.56,0.78,1.0};
			
			Int_t FI = TColor::CreateGradientColorTable(6,stp,red,grn,blu,ncol) ;
			for (int i=0; i<ncol; i++) col1[i] = FI+i;
		}
		{
			Double_t blu[] = {0,0,1,0,0};
			Double_t red[] = {0,1,1,0,0};
			Double_t grn[] = {0,0,1,1,0};
			Double_t stp[] = {0.,0.25,0.5,0.75,1.0};
			
			Int_t FI = TColor::CreateGradientColorTable(5,stp,red,grn,blu,ncol);
...
{
	TComplex bw  = BreitWigner(m, r->GetM0(), r->GetG0(), m1, m2, r->GetJ());
