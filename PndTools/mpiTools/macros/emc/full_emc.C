void full_emc(Char_t InputSimFile[]="sim_emc.root", Char_t OutputDatabaseFile[] = "simparams.root", Char_t OutputFullFile[]="full_emc.root")
{
  ...
  // It loads a simulation file and digitize hits for EMC
	...
	// Parameter file
	TString parFile = OutputDatabaseFile; // at the moment you do not need it
  
	// Digitisation file (ascii)
	TString digiFile = "emc.par";
  
	// Output file
	TString outFile = OutputFullFile;
