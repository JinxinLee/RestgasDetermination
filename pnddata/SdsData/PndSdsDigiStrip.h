...
class PndSdsDigiStrip : public PndSdsDigi
  {
    ...
    PndSdsDigiStrip(std::vector<Int_t> index, Int_t detID, Int_t sensorID, Int_t fe, Int_t chan, Double_t charge, Int_t mcPointType, Int_t timestamp = -1);
    PndSdsDigiStrip(Int_t index, Int_t detID, Int_t sensorID, Int_t fe, Int_t chan, Double_t charge, Int_t mcPointType, Int_t timestamp = -1);
    ~PndSdsDigiStrip(){};
