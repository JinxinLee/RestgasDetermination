...
bool PndRichPhoton::TrackCalc()
{
   ...
   if (fMirrors.size()==1) {
      ...
      if ( std::fabs(p0.X()-fMirrors[0]->GetPoint().X())<fMirrors[0]->GetDims().X() &&
           std::fabs(p0.Y()-fMirrors[0]->GetPoint().Y())<fMirrors[0]->GetDims().Y() &&
   ...
   if (fMirrors.size()==2) {
      ...
      if ( std::fabs(q1.X()-fMirrors[0]->GetPoint().X())<fMirrors[0]->GetDims().X() &&
           std::fabs(q1.Y()-fMirrors[0]->GetPoint().Y())<fMirrors[0]->GetDims().Y() &&
           std::fabs(q1.Z()-fMirrors[0]->GetPoint().Z())<fMirrors[0]->GetDims().Z() &&
           std::fabs(q2.X()-fMirrors[1]->GetPoint().X())<fMirrors[1]->GetDims().X() &&
           std::fabs(q2.Y()-fMirrors[1]->GetPoint().Y())<fMirrors[1]->GetDims().Y() &&
           std::fabs(q2.Z()-fMirrors[1]->GetPoint().Z())<fMirrors[1]->GetDims().Z() ) {
         fMirrRefPosition.clear();
