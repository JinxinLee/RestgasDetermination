...
{
private: struct PixelTraits;
public:
    SensorGridPhotodetector(SensorGridBase* sensor_grid_, bool per_pixel_traits_,
...
public:
    ...
    int  Detect(double const & hit_pos_x, double const & hit_pos_y, double const & hit_time_ns,
                double const & wavelength_nm, PixelInfo & pixel_info, double & smeared_time_ns) const;
