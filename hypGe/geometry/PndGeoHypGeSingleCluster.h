...
public:
  ...
  PndGeoHypGeSingleCluster(TGeoMedium *ExtGe, TGeoMedium *ExtAl,TGeoMedium *ExtCu,Int_t ExtClusterNumber);		// the extCu variable must be put into the inherited function later (30.07.14)
