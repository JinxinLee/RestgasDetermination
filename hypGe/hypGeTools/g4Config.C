...
/// character: eg. stepLimit+specialCuts.
   ...
   TG4RunConfiguration* runConfiguration 
           ...
           = new TG4RunConfiguration("geomRoot", /*"QGSP_BIC_HP"*/"QGSP_BERT_HP", "stepLimiter+specialCuts+specialControls");		// Marcell edt changed on 08.07.13 for COSY simulation
...
/// create the Specific stack
   ...
   //stack->SetMinPoints(1);			// secondaries need hit in active volume
   stack->SetMinPoints(0);				// no hit needed for secondaries in active volume
