...
echo "# For example                                                    #"
echo "#!/bin/bash                                                      #"
echo "#export LINUX_FLAVOUR=Ubuntu14-10                                #"
echo "#export FAIRSOFT_VERSION=mar15                                   #"
echo "#export FAIRROOT_VERSION=v-15.03                                 #"
echo "#export SIMPATH=<path_to_installation_of_fairsoft_packages>      #"
echo "#export FAIRROOTPATH=<path_to_installation_of_fairroot_packages> #"
echo "#export BUILDDIR=<path_to_installation_of_pandaroot_packages>    #"
echo "#export SOURCEDIR=<path_to_source_of_pandaroot_packages>         #"
...
ctest -S $SOURCEDIR/PandaRoot_test.cmake -V --VV 
