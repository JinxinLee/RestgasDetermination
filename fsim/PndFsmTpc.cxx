...
//      $Id: FsmTpc.cc,v 1.9 2007/05/24 08:07:40 klausg Exp $
//
// Description:
//      Class FsmTpc
//      
...
PndFsmTpc::PndFsmTpc(ArgList &par) 
{
  initParameters();
...
PndFsmResponse* 
PndFsmTpc::respond(PndFsmTrack *t)
{
...
double
PndFsmTpc::gauss(double x, double x0, double s)
{
...
double 
PndFsmTpc::compdEdx(double p, double M)
{
  double dEdX;
...
bool 
PndFsmTpc::detected(PndFsmTrack *t) const
{
  if (t->hitMapValid()) {
...
double 
PndFsmTpc::dp(PndFsmTrack *t) const
{
  double p=t->p4().Vect().Mag();
  double Dp=_pRes*p;  
...
double
PndFsmTpc::dphi(PndFsmTrack *t) const
{ 
...
double
PndFsmTpc::dtheta(PndFsmTrack *t) const
{ 
...
bool
PndFsmTpc::setParameter(std::string &name, double value)
{
  // *****************
