...
//      $Id: PndFsmMvdPid.cc,v 1.10 2007/05/24 08:07:40 klausg Exp $
//
// Description:
//      Class PndFsmMvdPid
//
...
bool
PndFsmMvdPid::detected(PndFsmTrack *t) const
{
...
bool
PndFsmMvdPid::setParameter(std::string &name, double value)
{
  // *****************
...
double PndFsmMvdPid::MeanEnergyLoss(PidType part) {
...
double PndFsmMvdPid::LandauGaus(double s_mpv, double widthone, double widthtwo) {
...
double PndFsmMvdPid::width1(PidType part) {
  double x=_momentum;
  switch(part) {
  case proton:
    if (x>=1.10)
