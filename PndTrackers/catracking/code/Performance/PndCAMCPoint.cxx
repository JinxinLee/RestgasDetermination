// $Id: PndCAMCPoint.cxx,v 1.2 2010/09/01 10:38:27 ikulakov Exp $
//***************************************************************************
...
PndCAMCPoint::PndCAMCPoint()
    : fX( 0 ), fY( 0 ), fZ( 0 ), fSx( 0 ), fSy( 0 ), fSz( 0 ), fTime( 0 ), fISlice( 0 ), fTrackID( 0 )
{
  //* Default constructor
}

ostream& operator<<(ostream& out, const PndCALocalMCPoint &a)
{
...
istream& operator>>(istream& in, PndCALocalMCPoint &a)
{
  in >> a.fX >> a.fY >> a.fZ;
...
void PndCALocalMCPoint::RotateXY( float alpha) {
