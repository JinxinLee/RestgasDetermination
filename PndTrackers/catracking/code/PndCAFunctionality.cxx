...
float_m PndCAFunctionality::FitIteration(const PndCAParam& caParam, const PndCAHits& hits, PndCATrackParamVector& param, const vector<PndCATESV>& iHits, const PndCATarget& target, bool dir, bool useParam, const float_m& mask)
{
...
float_m PndCAFunctionality::Fit(const PndCAParam& caParam, const PndCAHits& hits, PndCATrackParamVector& param, const vector<PndCATESV>& iHits, const PndCATarget& target, bool dir, const float_m& mask)
{
  float_m active = mask;
  int i = 0;
