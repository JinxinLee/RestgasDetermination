// $Id: PndCATrackParam.cxx,v 1.6 2011/05/20 16:11:22 fisyak Exp $
// **************************************************************************
...
float  PndCATrackParam::GetS( float x, float y, float Bz ) const
{
...
void  PndCATrackParam::GetDCAPoint( float x, float y, float z,
...
bool  PndCATrackParam::TransportToX( float x, float sinPhi0, float cosPhi0,  float Bz, float maxSinPhi )
{
...
bool  PndCATrackParam::TransportToX( float x, float Bz, float maxSinPhi )
{
...
bool PndCATrackParam::TransportToXWithMaterial( float x, float Bz, float maxSinPhi )
{
...
float PndCATrackParam::BetheBlochGeant( float bg2,
    float kp0,
    float kp1,
    float kp2,
    float kp3,
...
bool PndCATrackParam::Rotate( float alpha, float maxSinPhi )
{
...
bool PndCATrackParam::Rotate( float alpha, PndCATrackLinearisation &t0, float maxSinPhi )
{
  //* Rotate the coordinate system in XY on the angle alpha
...
/*bool PndCATrackParam::Filter( float y, float z, float err2Y, float err2Z, float maxSinPhi )
{
...
// std::istream &operator>>( std::istream &in, PndCATrackParam &t )
// {
//   in >> t.fX;
//   in >> t.fSignCosPhi;
//   in >> t.fChi2;
...
// }
// 
// std::ostream &operator<<( std::ostream &out, const PndCATrackParam &t )
// {
//   out << t.X() << " "
//   << t.SignCosPhi() << " "
//   << t.Chi2() << " "
