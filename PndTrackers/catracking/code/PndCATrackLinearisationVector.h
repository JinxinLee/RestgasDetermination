...
inline PndCATrackLinearisationVector::PndCATrackLinearisationVector( const PndCATrackParamVector &t )
...
inline void PndCATrackLinearisationVector::Set( float_v SinPhi1, float_v CosPhi1,
