...
float_m CAFunctionality::FitIteration(const PndFTSCAParam& caParam, const FTSCAHits& hits, PndFTSCATrackParamVector& param, const vector<TESV>& iHits, const FTSCATarget& target, bool dir, bool useParam, const float_m& mask)
{
...
float_m CAFunctionality::Fit(const PndFTSCAParam& caParam, const FTSCAHits& hits, PndFTSCATrackParamVector& param, const vector<TESV>& iHits, const FTSCATarget& target, bool dir, const float_m& mask)
{
...
float_m CAFunctionality::FitUseParam(const PndFTSCAParam& caParam, const FTSCAHits& hits, PndFTSCATrackParamVector& param, const vector<TESV>& iHits, const FTSCATarget& target, bool dir,  bool usePar, const float_m& mask)
{
  float_m active1 = mask;
  int_v maskvar(1);
  foreach_bit(unsigned short iV, active1) 
