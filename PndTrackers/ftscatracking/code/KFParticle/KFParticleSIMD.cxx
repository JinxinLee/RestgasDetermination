...
void KFParticleSIMD::Create( const fvec Param[], const fvec Cov[], fvec Charge, fvec mass /*Int_t PID*/ )
{
...
#ifdef HomogeneousField
fvec KFParticleSIMD::GetDistanceFromVertexXY( const KFPVertex &Vtx, fvec &val, fvec &err ) const 
{
  //* Calculate distance from vertex [cm] in XY-plane
