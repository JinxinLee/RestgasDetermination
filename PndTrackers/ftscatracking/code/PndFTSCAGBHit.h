...
class PndFTSCAGBHit
{
  public:
    PndFTSCAGBHit()
        : fX( 0 ), fY( 0 ), fZ( 0 ), fErr2X0( 0 ), fErr2X1( 0 ), fErrX12( 0 ), fErr2X2( 0 ),
        fIRow( 0 ), fID( 0 ), fPhi( 0 )
#if defined(DRIFT_TUBES)
        , fR( 0 ), fErr2R( 0 ), fIsLeft( false ), fIsPileuped( false ), fXW(0), fYW(0), fZW(0),
          fTubeR( 0 ), fHalfLength( 0 ), fEX( 0 ), fEY( 0 ), fEZ( 0 )
#endif
  {}
