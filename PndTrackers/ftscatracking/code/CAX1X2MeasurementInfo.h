...
#ifndef CAX1X2MeasurementInfo_H
#define CAX1X2MeasurementInfo_H

class CAX1X2MeasurementInfo {
 public:
  CAX1X2MeasurementInfo( const float_v& c00, const float_v& c10, const float_v& c11 ):fC00(c00),fC10(c10),fC11(c11){}
