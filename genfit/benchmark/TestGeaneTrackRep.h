...
#ifndef TestGeaneTRACKREP_HH
#define TestGeaneTRACKREP_HH
...
class TestGeaneTrackRep : public AbsTrackRep {
public:

  // Constructors/Destructors ---------
  TestGeaneTrackRep();
  TestGeaneTrackRep(FairGeanePro* geane,
  ...
  virtual ~TestGeaneTrackRep();


  virtual AbsTrackRep* clone() const {return new TestGeaneTrackRep(*this);}
  virtual AbsTrackRep* prototype()const{return new TestGeaneTrackRep();}

  // Operators
  friend std::ostream& operator<< (std::ostream& s, const TestGeaneTrackRep& me);
