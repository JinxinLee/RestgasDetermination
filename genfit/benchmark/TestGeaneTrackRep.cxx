...
//
// Description:
//      Implementation of class TestGeaneTrackRep
//      see TestGeaneTrackRep.hh for details
//
// Environment:
...
TestGeaneTrackRep::TestGeaneTrackRep()
  : AbsTrackRep(5), _pdg(211),_backw(0)
{

}

TestGeaneTrackRep::TestGeaneTrackRep(FairGeanePro* geane, 
...
//  TestGeaneTrackRep::TestGeaneTrackRep(const TestGeaneTrackRep& rep) 
//   : AbsTrackRep(rep)
// {
//   _geane=rep._geane;
// }
...
double
TestGeaneTrackRep::extrapolate(const DetPlane& pl, 
			   ...
			   TMatrixT<double>& covPred)
{
  ...
  if(fabs(state[0][0])>10){
    FitterException exc("TestGeaneTrackRep: PROTECT AGAINST LOW MOMENTA",__LINE__,__FILE__);
	throw exc;
  }
...
TestGeaneTrackRep::extrapolateToPoca(const TVector3& pos,
  ...
  //std::cout<<"TestGeaneTrackRep::extrapolateToPoca"<<std::endl;
  //_refPlane.Print();
...
void 
TestGeaneTrackRep::extrapolateToLine(const TVector3& point1,
...
TVector3 
TestGeaneTrackRep::getPocaOnLine(const TVector3& p1, const TVector3& p2, bool back){
  
  //std::cout<<"TestGeaneTrackRep::getPocaToWire"<<std::endl;
...
TVector3 
TestGeaneTrackRep::getPos(const DetPlane& pl)
{
...
TVector3 
TestGeaneTrackRep::getMom(const DetPlane& pl)
{
  TMatrixT<double> statePred(state);
  if(pl!=_refPlane)extrapolate(pl,statePred);
  double fSPU  = _spu;
...
void
TestGeaneTrackRep::getPosMom(const DetPlane& pl,TVector3& pos, TVector3& mom)
{
  TMatrixT<double> statePred(state);
  if(pl!=_refPlane)extrapolate(pl,statePred);
