#ifndef PndMQSdsChargeWeightedPixelMapping_H
#define PndMQSdsChargeWeightedPixelMapping_H
...
class PndMQSdsChargeWeightedPixelMapping : public PndMQSdsPixelBackMapping
  {
    public :
