...
PndMvdMQTaskProcessor::PndMvdMQTaskProcessor()
  : FairMQDevice()
  , fNewRunId(1)
  , fCurrentRunId(-1)
  , fInput(NULL)
...
void PndMvdMQTaskProcessor::Init()
{
...
void PndMvdMQTaskProcessor::Run()
{
    int receivedMsgs = 0;
    int sentMsgs = 0;
...
void PndMvdMQTaskProcessor::CustomCleanup(void *data, void *hint)
{
...
void PndMvdMQTaskProcessor::SetProperty(const int key, const std::string& value)
{
    switch (key)
    {
        default:
...
std::string PndMvdMQTaskProcessor::GetProperty(const int key, const std::string& default_)
{
    switch (key)
    {
        default:
...
void PndMvdMQTaskProcessor::SetProperty(const int key, const int value)
{
    FairMQDevice::SetProperty(key, value);
}

int PndMvdMQTaskProcessor::GetProperty(const int key, const int value)
{
...
void PndMvdMQTaskProcessor::UpdateParameters() {
...
FairParGenericSet* PndMvdMQTaskProcessor::UpdateParameter(FairParGenericSet* thisPar) {
