...
//		std::cout << "first: " << *first << std::endl;
	...
	if (fInputArray->GetEntriesFast() > 1){
		...
		//			" diff " << second->GetTimeStamp() - first->GetTimeStamp() << std::endl;
			...
			else diff = first->GetTimeStamp() - second->GetTimeStamp();

			if ((first->GetSensorID() == 0 && second->GetSensorID() == 1)
					|| (first->GetSensorID() == 1 && second->GetSensorID() == 0))
				fHc0c1->Fill(diff);
			else if ((first->GetSensorID() == 0 && second->GetSensorID() == 2)
					|| (first->GetSensorID() == 2 && second->GetSensorID() == 0))
				fHc0c2->Fill(diff);
			else if ((first->GetSensorID() == 0 && second->GetSensorID() == 3)
					|| (first->GetSensorID() == 3 && second->GetSensorID() == 0))
				fHc0c3->Fill(diff);
			else if ((first->GetSensorID() == 1 && second->GetSensorID() == 2)
					|| (first->GetSensorID() == 2 && second->GetSensorID() == 1))
				fHc1c2->Fill(diff);
			else if ((first->GetSensorID() == 1 && second->GetSensorID() == 3)
					|| (first->GetSensorID() == 3 && second->GetSensorID() == 1))
				fHc1c3->Fill(diff);
			else if ((first->GetSensorID() == 2 && second->GetSensorID() == 3)
					|| (first->GetSensorID() == 3 && second->GetSensorID() == 2))
				fHc2c3->Fill(diff);
