...
public:
  ...
  virtual ~PndMvdAllDataEventAna(){};
	...
	void DrawHitPerCluster(TCanvas* extCan = 0, Int_t pad = 0){DrawHisto(fAllHitPerClusterHistos, extCan, pad);};
	void DrawResolution(TCanvas* extCan = 0, Int_t pad = 0){DrawHisto(fAllHitResolutionHistos, extCan, pad);};
