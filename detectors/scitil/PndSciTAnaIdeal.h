...
#include "../tracking/riemannfit/PndRiemannTrack.h"
#include <string>
...
class PndSciTAnaIdeal : public FairTask
{
 ...
 private:
  ...
  TH2F* histo;TH2F*map1;TH2F*map2;TH2F*map3;TH2F*map4; TH2F* histpi;
  TH2F* histk; TH2F* histp;
  TH1F* Dpi1;TH1F* Dpi2;TH1F* Dp2;TH1F* Dpix;
  TVector3 fvecp;
  Bool_t friemann;
  Bool_t fLHcut;
