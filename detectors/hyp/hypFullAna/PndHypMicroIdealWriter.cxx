...
PndHypMicroIdealWriter::~PndHypMicroIdealWriter() {
  ...
  if (fMicroIdealCandidates) {fMicroIdealCandidates->Delete(); delete fMicroIdealCandidates;}
...
void PndHypMicroIdealWriter::Exec(Option_t*) 
{
  ...
  if (fMicroIdealCandidates->GetEntriesFast() != 0) fMicroIdealCandidates->Clear("C");
