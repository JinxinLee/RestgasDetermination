...
class PndLmdBPtestTask : public FairTask {
 ...
 private:
  ...
  double fxrec, fyrec, fzrec, fprec, fthetarec, fphirec, fxmc, fymc, fzmc, fpmc,
      fthetamc, fphimc, fxmclmd, fymclmd, fzmclmd, fpmclmd, fthetamclmd,
      fphimclmd;
  double fxrec_err, fyrec_err, fxmc_err, fymc_err, fxmclmd_err, fymclmd_err;
  double fbx, fby, fbz;
  double fvrec, fwrec, ftvrec, ftwrec, fvrec_err, fwrec_err, ftvrec_err,
      ftwrec_err;
  double fvmc, fwmc, ftvmc, ftwmc, fvmc_err, fwmc_err, ftvmc_err, ftwmc_err;
  double fvmclmd, fwmclmd, ftvmclmd, ftwmclmd, fvmclmd_err, fwmclmd_err,
      ftvmclmd_err, ftwmclmd_err;
