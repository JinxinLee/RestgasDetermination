...
public:
	...
	PndLmdCalStrip(Double_t pitch,Double_t orient, Int_t nrStrips, Int_t nrFeChannels, const TVector2& firstStripAnchor,
    ...
    //for curve strips
//	PndLmdCalStrip(const PndLmdDigiPara *digipara, SensorSide side = kTOP);

	~PndLmdCalStrip(){};

	//public method for strips number calculation
    std::vector<PndLmdStrips> GetStrips(Double_t inx, Double_t iny, Double_t inz,
    		                    Double_t outx, Double_t outy, Double_t outz,Double_t eloss);
    //digi the strips
    std::vector<PndLmdStrips> DigiStripFromPoint(Double_t inx, Double_t iny, Double_t inz,
    		                   Double_t outx, Double_t outy, Double_t outz, Double_t eloss);

    std::vector<PndLmdStrips> GetCurveStrip(Double_t inx, Double_t iny, Double_t inz,
    		                   Double_t outx, Double_t outy, Double_t outz, Double_t eLoss);
