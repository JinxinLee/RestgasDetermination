...
InitStatus PndMdtTrkFinder::Init() {
  ...
  cout << "-I- PndMdtTrkFinder: Intialization successfull" << endl;
...
void PndMdtTrkFinder::SetParContainers() {
  ...
  if ( ! run ) Fatal("PndMdtTrkFinder:: SetParContainers", "No analysis run");
  
  FairRuntimeDb* db = run->GetRuntimeDb();
  if ( ! db ) Fatal("PndMdtTrkFinder:: SetParContainers", "No runtime database");
