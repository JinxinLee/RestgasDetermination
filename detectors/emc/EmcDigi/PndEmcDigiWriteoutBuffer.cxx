...
PndEmcDigiWriteoutBuffer::PndEmcDigiWriteoutBuffer(TString branchName, TString folderName, Bool_t persistance): FairWriteoutBuffer(branchName, "PndEmcDigi", folderName, persistance)
{
}
...
void PndEmcDigiWriteoutBuffer::AddNewDataToTClonesArray(FairTimeStamp* data)
{
  ...
  if (fVerbose > 1) std::cout << "Data Inserted: "  <<  *(PndEmcDigi*)(data) << std::endl;
