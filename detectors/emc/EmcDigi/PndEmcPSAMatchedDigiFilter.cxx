...
PndEmcPSAMatchedDigiFilter::PndEmcPSAMatchedDigiFilter(const std::vector<Double_t> params, PndEmcAbsPulseshape *pulseshape):
fParams(params),
...
void PndEmcPSAMatchedDigiFilter::GetHit(Int_t , Double_t &energy, Double_t &time){ // i //[R.K.03/2017] unused variable(s)
	energy = lAmplitude;
	time = lTime;
}
