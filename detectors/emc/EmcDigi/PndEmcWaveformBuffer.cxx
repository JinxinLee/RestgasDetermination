...
PndEmcWaveformBuffer::PndEmcWaveformBuffer():FairWriteoutBuffer(), fStoreWaveformData(kFALSE), fWfDataArray(NULL) {
}


PndEmcWaveformBuffer::PndEmcWaveformBuffer(TString branchName, TString className, TString folderName, Bool_t persistance): FairWriteoutBuffer(branchName, className, folderName, persistance), fStoreWaveformData(kFALSE), fWfDataArray(NULL) {
}
