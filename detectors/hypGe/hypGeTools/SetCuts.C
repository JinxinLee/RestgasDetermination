...
void SetCuts()
{
  ...
  Double_t cut2 = 1.0E-6;         // GeV --> 0.001 MeV
  Double_t cut3 = 1.0E-4;         // GeV --> 0.1 MeV
  ...
  gMC->SetCut("CUTGAM",cut2);   /** gammas (GeV)*/				// lower cut needed for low energy gammas
  gMC->SetCut("CUTELE",cut1);   /** electrons (GeV)*/
  gMC->SetCut("CUTNEU",cut3);   /** neutral hadrons (GeV)*/
