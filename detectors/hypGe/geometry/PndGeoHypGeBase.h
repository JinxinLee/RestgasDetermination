...
class PndGeoHypGeBase
{
	...
	public:
		...
		virtual ~PndGeoHypGeBase();
			...
			// function to build Arrays for TGeoArb8 for the side parts of the cryostat. Point1 and Point2 give the points (in xy-projection) between which the TGeoArb8 is build. The diffenent Offset give the height: 1 = 0.15 cm; 2 = 11.5 cm; 3 = 15.6493 cm; 4 = 18.5 cm
