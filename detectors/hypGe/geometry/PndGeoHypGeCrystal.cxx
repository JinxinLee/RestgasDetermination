...
// ----  constructor to use ----------------------------------
PndGeoHypGeCrystal::PndGeoHypGeCrystal(TGeoMedium *ExtGe, TGeoMedium *ExtAl,Int_t ExtCrystalNumber)
{
	Ge = ExtGe;
	Al = ExtAl;
...
void PndGeoHypGeCrystal::PlaceCrystal(TGeoVolume *top, TGeoMatrix* CrystalPlaceAndDirectionTranslation)
{
