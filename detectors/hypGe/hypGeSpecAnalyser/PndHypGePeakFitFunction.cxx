...
Double_t PndHypGePeakFitFunction::PeakFuncGaussian (Double_t *x,Double_t *par)
{
...
Double_t PndHypGePeakFitFunction::PeakFunc (Double_t *x,Double_t *par)
{
			// Peak shape is taken from gf2 http://www.phy.anl.gov/gammasphere/doc/gf2.hlp
			// composed by the sum of:
			//	(1) a Gaussian,
...
Double_t PndHypGePeakFitFunction::PeakFuncFreeSkewedPosition (Double_t *x,Double_t *par)
{
			// Peak shape is taken from gf2 http://www.phy.anl.gov/gammasphere/doc/gf2.hlp
			// composed by the sum of:
			//	(1) a Gaussian,
...
Double_t PndHypGePeakFitFunction::PeakFuncFreeSkewedPositionWithoutFirstGausian (Double_t *x,Double_t *par)
{
	return FreeSkewedOnly(x,par) + SmoothedStepOnly(x,par) + LinearOnly(x,par);
}

Double_t PndHypGePeakFitFunction::PeakFuncDoubleGausian (Double_t *x,Double_t *par)
{
			// Peak shape is taken from gf2 http://www.phy.anl.gov/gammasphere/doc/gf2.hlp
			// composed by the sum of:
			//	(1) a Gaussian,
...
// components
Double_t PndHypGePeakFitFunction::GausOnly (Double_t *x,Double_t *par)
{
...
Double_t PndHypGePeakFitFunction::SmoothedStepOnly (Double_t *x,Double_t *par)
{
			Double_t SmoothedStep = par[3] * TMath::Erfc( (x[0] - par[1]) /(TMath::Sqrt(2)*par[2])); // par[3]: amplitude
	return  SmoothedStep;
}

Double_t PndHypGePeakFitFunction::LinearOnly (Double_t *x,Double_t *par)
{
...
Double_t PndHypGePeakFitFunction::SkewedOnly (Double_t *x,Double_t *par)
{
...
Double_t PndHypGePeakFitFunction::FreeSkewedOnly (Double_t *x,Double_t *par)
{
			Double_t SkewedGausian = par[6] 
...
Double_t PndHypGePeakFitFunction::SecondGausOnly (Double_t *x,Double_t *par)
{
...
Double_t PndHypGePeakFitFunction::NewSkewedOnly(Double_t *x, Double_t *par)
{
...
Double_t PndHypGePeakFitFunction::NewFunction(Double_t *x, Double_t *par)		// added 27.08.14 seems to fit the june 2014 dataset best, skewed gaus + gaus + constant
{
