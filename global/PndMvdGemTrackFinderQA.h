// -------------------------------------------------------------------------
// -----                   PndMvdGemTrackFinderQA header file          -----
// -----                  Created 02.06.2009 by R. Karabowicz          -----
// -------------------------------------------------------------------------

/** \class PndMvdGemTrackFinderQA
...
#ifndef PNDMVDGEMTRACKFINDERQA_H
#define PNDMVDGEMTRACKFINDERQA_H
...
class PndMvdGemTrackFinderQA : public FairTask
{

 public:

  /** Default constructor **/
  PndMvdGemTrackFinderQA();

  /** Default constructor **/
  PndMvdGemTrackFinderQA(Int_t iVerbose);
  
  /** Destructor **/
  virtual ~PndMvdGemTrackFinderQA();
 ...
 private:
  ...
  TClonesArray* fMvdGemTrackArray;     	    ///< Output array of PndMvdGemTracks 
  ...
  ClassDef(PndMvdGemTrackFinderQA,1);
