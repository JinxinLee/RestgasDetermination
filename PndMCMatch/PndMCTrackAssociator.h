#ifndef MCTRACKASSOCIATOR_H
#define MCTRACKASSOCIATOR_H
...
class PndMCTrackAssociator : public FairTask {

 public:  
  
  PndMCTrackAssociator(const char *name, const char *title="PND Task");
  PndMCTrackAssociator();
  virtual ~PndMCTrackAssociator();
 ...
 protected:
  ...
  ClassDef(PndMCTrackAssociator,1)      // PndMCTrackAssociator
