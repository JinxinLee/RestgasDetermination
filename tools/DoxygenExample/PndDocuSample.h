 ...
 * 
 * For more, see the [original page](http://daringfireball.net/projects/markdown/syntax) or [this slightly more extensive example](http://www.unexpected-vortices.com/sw/rippledoc/quick-markdown-example.html).
 * 
 * ### Example
