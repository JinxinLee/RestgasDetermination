...
void anatut_psi2s(int nevts=0)
{
	...
	TH1F *hjpsim_nopid = new TH1F("hjpsim_nopid","J/#psi mass (no pid)",100,2,4);
	TH1F *hpsim_nopid  = new TH1F("hpsim_nopid","#psi(2S) mass (no pid)",100,3,5);
	TH1F *hjpsim_lpid = new TH1F("hjpsim_lpid","J/#psi mass (loose pid)",100,2,4);
	TH1F *hpsim_lpid  = new TH1F("hpsim_lpid","#psi(2S) mass (loose pid)",100,3,5);
	TH1F *hjpsim_tpid = new TH1F("hjpsim_tpid","J/#psi mass (true pid)",100,2,4);
	TH1F *hpsim_tpid  = new TH1F("hpsim_tpid","#psi(2S) mass (true pid)",100,3,5);
	
	TH1F *hjpsim_ftm = new TH1F("hjpsim_ftm","J/#psi mass (full truth match)",100,2,4);
	TH1F *hpsim_ftm  = new TH1F("hpsim_ftm","#psi(2S) mass ( truth match)",100,3,5);
	TH1F *hjpsim_nm = new TH1F("hjpsim_nm","J/#psi mass (no truth match)",100,2,4);
	TH1F *hpsim_nm  = new TH1F("hpsim_nm","#psi(2S) mass (no truth match)",100,3,5);
	...
	TH1F *hjpsim_vf   = new TH1F("hjpsim_vf","J/#psi mass vertex fit",100,2,4);
	TH1F *hjpsi_chi2  = new TH1F("hjpsi_chi2","J/#psi, #chi^{2} vertex fit",100,0,4);
	TH1F *hjpsim_4cf  = new TH1F("hjpsim_4cf","J/#psi mass (4C fit)",100,2,4);
