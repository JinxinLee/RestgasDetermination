// Macro for running minimal toy Panda root simulation to generate an example file
// for PndCudaExampleTask.
// Based on /macror/run/sim_complete.C as of 2013-09-10, modified by A. Herten

sim_toy(Int_t nEvents = 4, TString  SimEngine ="TGeant3", Float_t mom = 6.231552)
{
  //-----User Settings:-----------------------------------------------
  TString  OutputFile     ="sim_toy.root";
  TString  ParOutputfile  ="sim_toy_params.root";
