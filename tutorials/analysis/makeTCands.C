...
void makeTCands(int nevts=10)
{
  ...
  gSystem->Load("libRho");
	...
	TString inSimuFile = "data/points_sttcombi.root";
	TString inDigiFile = "data/digi_sttcombi.root";
	TString inRecoFile = "data/reco_sttcombi.root";
	TString inKalmFile = "data/fit_sttcombi.root";
	TString inLheFile = "data/lhepidmaker.root";
