{
  ...
  t->AddFriend("cbmsim","data/digi_sttcombi.root"); // the digi file
  t->AddFriend("cbmsim","data/reco_sttcombi.root"); // the reco file you want to analyse
  t->AddFriend("cbmsim","data/lhepidmaker.root"); // tracking output
  t->AddFriend("cbmsim","data/fit_sttcombi.root"); // debug output
