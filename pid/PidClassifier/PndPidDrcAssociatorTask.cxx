...
InitStatus PndPidDrcAssociatorTask::Init() {
  ...
  std::cout << "InitStatus PndPidDrcAssociatorTask::Init()" << std::endl;
...
//______________________________________________________
void PndPidDrcAssociatorTask::Exec(Option_t *) {
...
void PndPidDrcAssociatorTask::Register() {
  ...
  FairRootManager::Instance()->
    Register("PidAlgoDrc"+fTrackBranchNamePidHypo,"Pid", fPidChargedProb, kTRUE);
}
