...
c-------------------  Nessesary limits for PANDA ENERGY region ---------
      ...
      PARP(111)=0.5d0       ! Minimum invar. mass of the
                            ! remnant hadronic system (D=2.GeV)

   
       CKIN(1)= 1.0d0       ! limits for shat 

       CKIN(2)= -1.d0      ! no upper limit for S-HAT 

       CKIN(5)= 0.2d0      ! low cut limits for PT_-range
       CKIN(6)= 0.2d0      ! low cut limits for intermediate mass
