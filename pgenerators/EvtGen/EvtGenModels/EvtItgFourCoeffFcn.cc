...
EvtItgFourCoeffFcn::EvtItgFourCoeffFcn( double (*theFunction)(double, const std::vector<double> &, const std::vector<double> &, const std::vector<double> &, const std::vector<double> &), double flowerRange, double fupperRange, const std::vector<double> &coeffs1, const std::vector<double> &coeffs2, const std::vector<double> &coeffs3, const std::vector<double> &coeffs4):
...
void
EvtItgFourCoeffFcn::setCoeff(int vect, int which, double fvalue)
{
  if (vect == 1) _coeffs1[which] = fvalue;
  else if (vect == 2) _coeffs2[which] = fvalue;
  else if (vect == 3) _coeffs3[which] = fvalue;
  else if (vect == 4) _coeffs4[which] = fvalue;
}
