...
#include "EvtGenModels/EvtPP_X_PsiOmega_amp.hh"

EvtPP_X_PsiOmega_amp::EvtPP_X_PsiOmega_amp() {
    M0=mD0+mD0star;
...
EvtPP_X_PsiOmega_amp::EvtPP_X_PsiOmega_amp(const EvtPP_X_PsiOmega_amp& orig) {
    M0=mD0+mD0star;
    delta=mDch+mDchstar-mD0-mD0star;
    mu1=1/(1/mD0+1/mD0star); 
    mu2=1/(1/mDch+1/mDchstar);
...
void EvtPP_X_PsiOmega_amp::init() {}

EvtDecayBase* EvtPP_X_PsiOmega_amp::clone() { return new EvtPP_X_PsiOmega_amp;}


std::string EvtPP_X_PsiOmega_amp::getName() { return "PP_X_PsiOmega_amp";}


EvtComplex EvtPP_X_PsiOmega_amp::GammaRho(double e) {
    double re=0;
    if(e>-0.22)
...
EvtComplex EvtPP_X_PsiOmega_amp::GammaOmega(double e) {
    double re=0;
    if(e>-0.08)
...
EvtComplex EvtPP_X_PsiOmega_amp::invDD(double E) {
    EvtComplex k1, k2;
    EvtComplex I(0,1);
...
void EvtPP_X_PsiOmega_amp::initProbMax() {
    setProbMax(4.2e6);
}

void EvtPP_X_PsiOmega_amp::decay(EvtParticle* root) {
