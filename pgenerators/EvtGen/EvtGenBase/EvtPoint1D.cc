...
EvtPoint1D::EvtPoint1D(double fvalue)
  : _min(0.), _max(-1.), _value(fvalue), _valid(true)
{}

EvtPoint1D::EvtPoint1D(double min, double max, double fvalue)
  : _min(min), _max(max), _value(fvalue), _valid((_min <= _value && _value <= _max) ? true : false)
{} 
