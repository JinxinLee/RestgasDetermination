 ...
 * Package: EvtGenBase
 *    File: $Id: EvtPdfSum.hh,v 1.7 2003/06/20 17:20:10 dvoretsk Exp $
...
public:
  ...
  void addTerm(double fc,const EvtPdf<T>& fpdf)
  { assert(fc >= 0.); _c.push_back(fc); _term.push_back(fpdf.clone()); }

  void addOwnedTerm(double fc, EvtPdf<T>* fpdf)
  { _c.push_back(fc); _term.push_back(fpdf); }
...
protected:
  ...
  mutable EvtValError _itg; // propagated from EvtPdf, corrected by S.Spataro. It needs to be checked
}; 
