...
# Select another filter copying "Pdt"
  BooNew PdtFromDstarminus = Pdt
# Ask to have a D*- mother
  BooObjects PdtFromDstarminus ancestors D*-
# Create a filter with mother not a D*-
  BooNew PdtNotFromDstarminus = ! PdtFromDstarminus
# 
# Not strictly needed... anyway...
  BooCompose PdtFromCont = and Pdt PdtNotFromDstarminus
#
