...
# GfiEvtGen specifics:
# 
# Generator level filter requires both 
# 1) Lambda_c+      ->      p+ K- pi+  AND
...
#
# Note:  As of SP4, running this filter without forcing at least one
# (anti)Lambda_c will cause the program to crash when it runs out of 
# random seeds.
# 
...
# catch a bad Lambda1520 or anti-Lambda1520
  ...
  BooCompose theBeforeFilter = and NoBadLambda1520 two_pKpi
