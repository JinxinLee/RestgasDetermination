testExclusive(Int_t nEvents = 100, TString  SimEngine ="TGeant3",
        Float_t mom = 15.0, UInt_t seed = 123)
{
 ...
 //-------------------------  CAVE      -----------------
  ...
  //partonic model for unpolarized chi_{c2}
  chigen::models::chi_2 chi2;
  chigen::PndChiGenExclusive chigen(chi2);
